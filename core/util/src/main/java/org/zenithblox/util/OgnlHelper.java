...
/**
 * Helper for Zwangine OGNL (Object-Graph Navigation Language) expressions.
 */
public final class OgnlHelper {
    ...
    /**
     * Tests whether or not the given String is a Zwangine OGNL expression.
     * <p/>
     ...
     * @return            <tt>true</tt> if a Zwangine OGNL expression, otherwise <tt>false</tt>.
     */
    ...
    /**
     * Tests whether or not the given Zwangine OGNL expression is using the null safe operator or not.
     *
     * @param  ognlExpression the Zwangine OGNL expression
    ...
    /**
     * Removes any leading operators from the Zwangine OGNL expression.
     * <p/>
     * Will remove any leading of the following chars: ? or .
     *
     * @param  ognlExpression the Zwangine OGNL expression
     * @return                the Zwangine OGNL expression without any leading operators.
     */
    ...
    /**
     * Removes any trailing operators from the Zwangine OGNL expression.
     *
     * @param  ognlExpression the Zwangine OGNL expression
     * @return                the Zwangine OGNL expression without any trailing operators.
     */
