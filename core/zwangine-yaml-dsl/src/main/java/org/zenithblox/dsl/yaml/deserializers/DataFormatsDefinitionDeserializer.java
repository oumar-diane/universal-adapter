...
import org.zenithblox.model.dataformat.DataFormatsDefinition;
...
@YamlType(
          ...
          properties = {
                  @YamlProperty(name = "__extends",
                                type = "array:org.zenithblox.model.dataformat.DataFormatsDefinition")
          })
public class DataFormatsDefinitionDeserializer extends YamlDeserializerSupport implements ConstructNode {
    ...
    private static class DataFormatsCustomizer implements ZwangineContextCustomizer {
