...
public class YamlDeserializerSupport {
    ...
    public static Map<String, Object> asMap(Node node) {
        ...
        for (NodeTuple tuple : mn.getValue()) {
            ...
            switch (val.getNodeType()) {
                case SCALAR:
                    answer.put(StringHelper.dashToZwangineCase(key), asText(val));
                    break;
                case MAPPING:
                    answer.put(StringHelper.dashToZwangineCase(key), asMap(val));
                    break;
                default:
    ...
    public static String asEndpoint(MappingNode node) {
        ...
        final ZwangineContext cc = dc.getZwangineContext();
