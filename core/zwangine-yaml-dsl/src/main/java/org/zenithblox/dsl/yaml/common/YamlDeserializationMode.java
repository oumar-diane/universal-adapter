...
public enum YamlDeserializationMode {
     ...
     * Mimics the Java Dsl.
     * </p>
     * When the deserializer is configured to use this mode, a workflow can be defined using a syntax that is closed to the
     * Java DSL, as example, the following Java workflow:
     *
     * <pre>
     * {@code
     * from("direct:a")
     ...
     * </p>
     * See https://issues.zentihblox.org/jira/browse/CAMEL-16504
     */
    FLOW;
}
