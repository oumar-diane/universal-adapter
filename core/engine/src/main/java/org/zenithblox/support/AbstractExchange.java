...
import org.zenithblox.trait.message.RedeliveryTraitPayload;
 ...
 *
 * Zwangine end users should use {@link DefaultExchange} if creating an {@link Exchange} manually. However that is more
...
abstract class AbstractExchange implements Exchange {
    ...
    protected boolean workflowStop;
    ...
    protected AbstractExchange(ZwangineContext context, EnumMap<ExchangePropertyKey, Object> internalProperties,
    ...
    protected AbstractExchange(ZwangineContext context) {
        this(context, ExchangePattern.InOnly);
    }

    protected AbstractExchange(ZwangineContext context, ExchangePattern pattern) {
        this.context = context;
    ...
    protected AbstractExchange(Exchange parent) {
        ...
        privateExtension.setFromWorkflowId(parent.getFromWorkflowId());
    ...
    protected AbstractExchange(AbstractExchange parent) {
        ...
        setWorkflowStop(parent.workflowStop);
    ...
    public void setException(Throwable t) {
        if (t == null) {
            ...
            this.exception = ZwangineExecutionException.wrapZwangineExecutionException(this, t);
        }
    ...
    public String getFromWorkflowId() {
        return privateExtension.getFromWorkflowId();
    }
    ...
    @Override
    public boolean isWorkflowStop() {
        return workflowStop;
    }

    @Override
    public void setWorkflowStop(boolean workflowStop) {
        this.workflowStop = workflowStop;
    }
    ...
    protected void configureMessage(Message message) {
        if (message instanceof MessageSupport messageSupport) {
            ...
            messageSupport.setZwangineContext(getContext());
        }
    }
