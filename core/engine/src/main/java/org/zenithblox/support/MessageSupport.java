 ...
 */
public abstract class MessageSupport implements Message, ZwangineContextAware, DataTypeAware {
    ...
    protected <T> T getBody(Class<T> type, Object body) {
        ...
        if (e != null) {
            ...
            // fallback and try the message itself (e.g. used in zwangine-http)
    ...
    public void setBody(Object body) {
        ...
        if (body != null && zwangineContext != null && zwangineContext.isUseDataType()) {
