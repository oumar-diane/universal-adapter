 ...
 * lifecycle as {@link org.zenithblox.Service} or {@link org.zenithblox.SuspendableService} would do. If your
...
public class ProcessorEndpoint extends DefaultPollingEndpoint {
    ...
    public ProcessorEndpoint(String endpointUri, ZwangineContext context, Processor processor) {
        super(endpointUri, null);
        this.setZwangineContext(context);
