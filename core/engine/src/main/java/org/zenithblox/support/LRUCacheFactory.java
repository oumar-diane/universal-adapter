...
public abstract class LRUCacheFactory {
    ...
    /**
     * Use this to set a specific LRUCacheFactory instance, such as before starting Zwangine, that then avoids doing auto
    ...
    private static LRUCacheFactory createLRUCacheFactory() {
        ...
        try {
            ...
            URL url = classLoader.getResource("META-INF/services/org/zentihblox/zwangine/" + FACTORY);
            if (url != null) {
