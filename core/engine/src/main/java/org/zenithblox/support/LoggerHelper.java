...
import org.zenithblox.NamedWorkflow;
...
public final class LoggerHelper {
    ...
    public static String getLineNumberLoggerName(Object node) {
        ...
        if (node instanceof LineNumberAware) {
            if (node instanceof NamedWorkflow namedWorkflow) {
                // we want the input from a workflow as it has the source location / line number
                node = namedWorkflow.getInput();
            }
