...
import static org.zenithblox.util.StringHelper.between;

/**
 * A helper class for working with <a href="http://zwangine.zwangine.org/expression.html">expressions</a>.
 */
public class ExpressionBuilder {
        ...
        return new ExpressionAdapter() {
            ...
            public Object evaluate(Exchange exchange) {
                ...
                if (mandatory && answer == null) {
                    throw RuntimeZwangineException.wrapRuntimeZwangineException(new NoSuchHeaderException(exchange, key, null));
                }
                return answer;
            }
        ...
        return new ExpressionAdapter() {
            ...
            public Object evaluate(Exchange exchange) {
                ...
                try {
                    ...
                    throw ZwangineExecutionException.wrapZwangineExecutionException(exchange, e);
                }
    ...
    public static Expression variableExpression(final Expression variableName, final boolean mandatory) {
        return new ExpressionAdapter() {
            ...
            public Object evaluate(Exchange exchange) {
                ...
                if (mandatory && answer == null) {
                    throw RuntimeZwangineException.wrapRuntimeZwangineException(new NoSuchVariableException(exchange, key));
                }
                return answer;
            }
    ...
    /**
     * Returns an expression for the {@link org.zenithblox.spi.Registry}
     *
    ...
    /**
     * Returns an expression for lookup a bean in the {@link org.zenithblox.spi.Registry}
     *
    ...
    /**
     * Returns an expression for the {@link ZwangineContext}
     *
     * @return an expression object which will return the zwangine context
     */
    public static Expression zwangineContextExpression() {
        return new ExpressionAdapter() {
    ...
    /**
     * Returns an expression for the {@link ZwangineContext} name
     *
     * @return an expression object which will return the zwangine context name
     */
    public static Expression zwangineContextNameExpression() {
    ...
    public static Expression exchangePropertyExpression(final Expression propertyName, final boolean mandatory) {
        return new ExpressionAdapter() {
            ...
            public Object evaluate(Exchange exchange) {
                ...
                if (mandatory && answer == null) {
                    throw RuntimeZwangineException.wrapRuntimeZwangineException(new NoSuchPropertyException(exchange, key));
                }
                return answer;
            }
    ...
    /**
     * Returns an expression for the properties of the zwangine context
     *
     * @return an expression object which will return the properties
     */
    public static Expression zwangineContextPropertiesExpression() {
        return new ExpressionAdapter() {
            ...
            @Override
            public String toString() {
                return "zwangineContextProperties";
            }
        };
    }

    /**
     * Returns an expression for the property value of the zwangine context with the given name
     *
     * @param  propertyName the name of the property the expression will return
     * @return              an expression object which will return the property value
     */
    public static Expression zwangineContextPropertyExpression(final String propertyName) {
        return zwangineContextPropertyExpression(simpleExpression(propertyName));
    }
     ...
     * @return              an expression object which will return the property value
     */
    public static Expression zwangineContextPropertyExpression(final Expression propertyName) {
        return new ExpressionAdapter() {
            @Override
            public Object evaluate(Exchange exchange) {
            ...
            @Override
            public String toString() {
                return "zwangineContextProperty(" + propertyName + ")";
            }
        };
    }
    ...
    /**
     * Returns an Expression for the workflow id
     */
    public static Expression workflowIdExpression() {
        return new ExpressionAdapter() {
            @Override
            public Object evaluate(Exchange exchange) {
                return ExchangeHelper.getWorkflowId(exchange);
            }
    ...
    /**
     * Returns an Expression for the original workflow id where this exchange was created.
     */
    public static Expression fromWorkflowIdExpression() {
        return new ExpressionAdapter() {
            @Override
            public Object evaluate(Exchange exchange) {
    ...
    /**
     * Returns an Expression for the workflow group
     */
    public static Expression workflowGroupExpression() {
        return new ExpressionAdapter() {
            @Override
            public Object evaluate(Exchange exchange) {
                return ExchangeHelper.getWorkflowGroup(exchange);
            }
