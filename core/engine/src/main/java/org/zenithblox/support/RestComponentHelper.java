...
import org.zenithblox.util.HostUtils;
...
public final class RestComponentHelper {
     ...
     * @param  verb       the HTTP verb for the workflow
     ...
     * @param  path               the HTTP path of the workflow
     * @param  queryMap           the endpoint query options
     * @return                    a string of the component workflow url
     ...
     *
     * @param  componentName      the name of the rest component
     * @param  scheme             the scheme of the HTTP workflow http/https
     * @param  host               the host of the HTTP workflow
     * @param  port               the port the workflow will be exposed through
     * @param  path               the HTTP path of the workflow
     * @param  queryMap           the endpoint query options
     * @return                    a string of the component workflow url
     * @throws URISyntaxException - is thrown if uri has invalid syntax.
