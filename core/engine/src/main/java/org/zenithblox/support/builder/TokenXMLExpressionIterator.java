...
/**
 * {@link org.zenithblox.Expression} to walk a {@link org.zenithblox.Message} XML body using an
 * {@link Iterator}, which grabs the content between a XML start and end token, where the end token
 * corresponds implicitly to either the end tag or the self-closing start tag.
 * <p/>
 * The message body must be able to convert to {@link InputStream} type which is used as stream to access the
 * message body.
 * <p/>
