...
public class JndiContext implements Context, Serializable {
    ...
    protected Map<String, Object> internalBind(String name, Object value) throws NamingException {
        org.zenithblox.util.ObjectHelper.notNullOrEmpty(name, "name");
        org.zenithblox.util.ObjectHelper.notNull(frozen, "frozen");
        ...
        if (pos == -1) {
            ...
            org.zenithblox.util.ObjectHelper.notNullOrEmpty(segment, "segment");
