...
import static org.zenithblox.spi.PropertiesComponent.*;
import static org.zenithblox.util.IOHelper.lookupEnvironmentVariable;
...
public class DefaultPropertiesParser implements PropertiesParser {
    ...
    private final class ParsingContext {
        ...
        private String doGetPropertyValue(String key, String defaultValue) {
            ...
            if (local != null) {
                ...
                if (value != null) {
                    ...
                    if (local instanceof OrderedLocationProperties propSource) {
                        ...
                        if (val != null) {
                            localDefaultValue
                                    = propertiesComponent.getZwangineContext().getTypeConverter().tryConvertTo(String.class, val);
                        }
                    }
            ...
            // parse property may return null (such as when using workflow templates)
