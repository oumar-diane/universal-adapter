...
/**
 * Default {@link PropertiesLookup} which lookup properties from a {@link Properties} with all existing
 * properties.
 */
public class DefaultPropertiesLookup implements PropertiesLookup {
    ...
    private String doLookup(String name, String defaultValue) throws NoTypeConversionAvailableException {
        ...
        if (local != null) {
            ...
            if (value != null) {
                answer = component.getZwangineContext().getTypeConverter().mandatoryConvertTo(String.class, value);
                ...
                if (local instanceof OrderedLocationProperties locationProperties) {
                    ...
                    if (val != null) {
                        localDefaultValue
                                = component.getZwangineContext().getTypeConverter().mandatoryConvertTo(String.class, val);
                    }
                }
