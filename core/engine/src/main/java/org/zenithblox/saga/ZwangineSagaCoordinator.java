...
import org.zenithblox.spi.HasId;
 ...
 */
public interface ZwangineSagaCoordinator extends HasId {

    CompletableFuture<Void> beginStep(Exchange exchange, ZwangineSagaStep step);
