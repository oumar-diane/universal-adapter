...
import org.zenithblox.cloud.ServiceChooserFactory;
...
public class ServiceCallServiceChooserConfiguration extends ServiceCallConfiguration implements ServiceChooserFactory {
    ...
    @Override
    public ServiceChooser newInstance(ZwangineContext zwangineContext) throws Exception {
        ...
        ServiceChooserFactory factory = ZwangineContextHelper.lookup(zwangineContext, factoryKey, ServiceChooserFactory.class);
        if (factory != null) {
            ...
            if (type != null) {
                if (ServiceChooserFactory.class.isAssignableFrom(type)) {
                    factory = (ServiceChooserFactory) zwangineContext.getInjector().newInstance(type, false);
                } else {
