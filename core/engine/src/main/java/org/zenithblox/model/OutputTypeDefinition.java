...
/**
 * Set the expected data type of the output message. If the actual message type is different at runtime, zwangine look for
 * a required {@link Transformer} and apply if exists. If validate attribute is true then zwangine applies
