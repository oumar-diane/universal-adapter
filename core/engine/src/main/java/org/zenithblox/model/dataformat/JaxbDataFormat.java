...
public class JaxbDataFormat extends DataFormatDefinition implements ContentTypeHeaderAware {
     ...
     * enable this behaviours you need set property partClass. Zwangine will pass this class to JAXB's unmarshaler.
     */
     ...
     * as ns2, ns3, ns4 etc. To control this mapping, Zwangine allows you to refer to a map which contains the desired
     * mapping.
     */
    ...
    public static class Builder implements DataFormatBuilder<JaxbDataFormat> {
         ...
         * partial unmarshalling. To enable this behaviours you need set property partClass. Zwangine will pass this class
         ...
         * prefixes, such as ns2, ns3, ns4 etc. To control this mapping, Zwangine allows you to refer to a map which
