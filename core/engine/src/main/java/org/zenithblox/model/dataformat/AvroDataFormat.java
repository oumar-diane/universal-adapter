...
/**
 * Serialize and deserialize messages using  Avro binary data format.
 */
...
public class AvroDataFormat extends DataFormatDefinition {
    ...
    @Metadata(label = "advanced", javaType = "org.zenithblox.component.jackson.SchemaResolver")
    ...
    /**
     * To use custom Jackson modules referred from the Zwangine registry. Multiple modules can be separated by comma.
     */
    ...
    /**
     * If enabled then Jackson is allowed to attempt to use the ZwangineJacksonUnmarshalType header during the
     * unmarshalling.
     * <p/>
    ...
    public static class Builder implements DataFormatBuilder<AvroDataFormat> {
        ...
        private Object schema;
        private String instanceClassName;
        private AvroLibrary library = AvroLibrary.Avro;
        private String objectMapper;
        private String useDefaultObjectMapper;
        private String unmarshalTypeName;
        private String jsonViewTypeName;
