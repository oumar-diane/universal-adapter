...
public class PollEnrichDefinition extends ExpressionNode
    ...
    /**
     * Sets the maximum size used by the {@link org.zenithblox.spi.ConsumerCache} which is used to cache and reuse
    ...
    /**
     * Whether to allow components to optimise if they are {@link org.zenithblox.spi.SendDynamicAware}.
     *
     * @return the builder
     */
