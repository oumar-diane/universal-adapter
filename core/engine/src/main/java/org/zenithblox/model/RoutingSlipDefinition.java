...
import org.zenithblox.model.language.HeaderExpression;
...
public class RoutingSlipDefinition<Type extends ProcessorDefinition<Type>> extends ExpressionNode {
    ...
    /**
     * Expression to define the routing slip, which defines which endpoints to workflow the message in a pipeline style.
     * Notice the expression is evaluated once, if you want a more dynamic style, then the dynamic workflowr eip is a
     * better choice.
     */
    @Override
