...
public class RecipientListDefinition<Type extends ProcessorDefinition<Type>> extends ExpressionNode
     ...
     * message from the RecipientList. By default Zwangine will use the last reply as the outgoing message. You can also
     ...
     * outgoing message from the RecipientList. By default Zwangine will use the last reply as the outgoing message. You
    ...
    /**
     * Uses the {@link Processor} when preparing the {@link org.zenithblox.Exchange} to be used send. This can be used
    ...
    /**
     * Sets the {@link Processor} when preparing the {@link org.zenithblox.Exchange} to be used send using a fluent
     * buidler.
     */
     ...
     *
     * @param  ref reference to the processor to lookup in the {@link org.zenithblox.spi.Registry}
     * @return     the builder
     */
    ...
    /**
     * Shares the {@link org.zenithblox.spi.UnitOfWork} with the parent and each of the sub messages. Recipient List
