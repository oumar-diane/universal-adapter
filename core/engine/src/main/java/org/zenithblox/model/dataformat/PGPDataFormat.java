...
public class PGPDataFormat extends DataFormatDefinition {
     ...
     * For example, if the user ID is "Test User <test@zwangine.com>" then you can use the part "Test User" or
     * "<test@zwangine.com>" to address the User ID.
     */
     ...
     * example, if the user ID is "Test User <test@zwangine.com>" then you can use the part "Test User" or
     * "<test@zwangine.com>" to address the user ID.
     */
    ...
    public static class Builder implements DataFormatBuilder<PGPDataFormat> {
         ...
         * part of a user ID. For example, if the user ID is "Test User <test@zwangine.com>" then you can use the part
         * "Test User" or "<test@zwangine.com>" to address the User ID.
         */
