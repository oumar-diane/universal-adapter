...
public class ClaimCheckDefinition extends NoOutputDefinition<ClaimCheckDefinition> {
    ...
    @Metadata(enums = "Get,GetAndRemove,Set,Push,Pop", javaType = "org.zenithblox.model.ClaimCheckOperation")
    private String operation;
    private String key;
    private String filter;
    @Metadata(label = "advanced", javaType = "org.zenithblox.AggregationStrategy")
