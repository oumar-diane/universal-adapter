...
public class EnrichDefinition extends ExpressionNode
     ...
     * message. By default Zwangine will use the reply from the external service as outgoing message.
     */
    @Override
    ...
    /**
     * Shares the {@link org.zenithblox.spi.UnitOfWork} with the parent and the resource exchange. Enrich will by
    ...
    /**
     * Whether to allow components to optimise enricher if they are {@link org.zenithblox.spi.SendDynamicAware}.
     *
     * @return the builder
     */
