...
public class SoapDataFormat extends DataFormatDefinition {
     ...
     * <p/>
     * All three classes is located in the package name org.zenithblox.dataformat.soap.name
     * <p/>
    ...
    public static class Builder implements DataFormatBuilder<SoapDataFormat> {
         ...
         * such as ns2, ns3, ns4 etc. To control this mapping, Zwangine allows you to refer to a map which contains the
         * desired mapping.
         */
