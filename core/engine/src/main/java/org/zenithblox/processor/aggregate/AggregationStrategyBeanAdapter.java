 ...
 * <p/>
 * This allows end users to use POJOs for the aggregation logic, instead of having to implement the Zwangine API
 * {@link AggregationStrategy}.
 */
public final class AggregationStrategyBeanAdapter extends ServiceSupport implements AggregationStrategy, ZwangineContextAware {
    ...
    protected void doStart() throws Exception {
        ...
        if (!isStaticMethod(found) && pojo == null) {
            pojo = zwangineContext.getInjector().newInstance(type);
        }
        ...
        // in case the POJO is ZwangineContextAware
        ZwangineContextAware.trySetZwangineContext(pojo, getZwangineContext());
