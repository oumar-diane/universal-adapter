 ...
 * Exchange will hold all the aggregated exchanges in a {@link List} as a exchange property with the key
 * {@link org.zenithblox.Exchange#GROUPED_EXCHANGE}.
 * <p/>
 * The method {@link #isStoreAsBodyOnCompletion()} determines if the aggregated {@link List} should be stored on the
 * {@link org.zenithblox.Message#setBody(Object)} or be kept as a property on the exchange. <br/>
