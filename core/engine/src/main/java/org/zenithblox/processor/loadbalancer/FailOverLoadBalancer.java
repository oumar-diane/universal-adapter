 ...
 */
public class FailOverLoadBalancer extends LoadBalancerSupport implements Traceable, ZwangineContextAware {
    ...
    public boolean isRunAllowed() {
        ...
        boolean forceShutdown = zwangineContext.getShutdownStrategy().isForceShutdown();
        if (forceShutdown) {
    ...
    protected class State {
        ...
        public void run() {
            ...
            processor.process(copy, doneSync -> exchange.getContext().getZwangineContextExtension().getReactiveExecutor()
                    .schedule(this::run));
        }
