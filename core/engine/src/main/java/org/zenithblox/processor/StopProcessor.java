...
/**
 * Stops continue processing the workflow and marks it as complete.
 */
public class StopProcessor extends AsyncProcessorSupport implements IdAware, WorkflowIdAware {
