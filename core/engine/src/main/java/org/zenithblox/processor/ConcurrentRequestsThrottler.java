...
public class ConcurrentRequestsThrottler extends AbstractThrottler {
    ...
    private static final String DEFAULT_KEY = "ZwangineThrottlerDefaultKey";

    private static final String PROPERTY_EXCHANGE_QUEUED_TIME = "ZwangineThrottlerExchangeQueuedTime";
    private static final String PROPERTY_EXCHANGE_STATE = "ZwangineThrottlerExchangeState";
    ...
    public ConcurrentRequestsThrottler(final ZwangineContext zwangineContext, final Expression maxRequestsExpression,
