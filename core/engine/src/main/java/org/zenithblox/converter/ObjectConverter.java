...
/**
 * Some core java.lang based <a href="http://zwangine.zwangine.org/type-converter.html">Type Converters</a>
 */
...
public final class ObjectConverter {
    ...
    public static Boolean toBoolean(Object value) {
        return org.zenithblox.util.ObjectHelper.toBoolean(value);
    }
    ...
    public static Byte toByte(Number value) {
        if (org.zenithblox.util.ObjectHelper.isNaN(value)) {
            return null;
        }
     ...
     */
    @Converter(order = 15)
    public static Class<?> toClass(String value, ZwangineContext zwangineContext) {
        // prefer to use class resolver API
        if (zwangineContext != null) {
            return zwangineContext.getClassResolver().resolveClass(value);
        } else {
            return org.zenithblox.util.ObjectHelper.loadClass(value);
        }
    }
