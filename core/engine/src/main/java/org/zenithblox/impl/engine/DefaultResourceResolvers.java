...
import org.zenithblox.spi.ContentTypeAware;
import org.zenithblox.spi.Resource;
import org.zenithblox.spi.annotations.ResourceResolver;
import org.zenithblox.support.ZwangineContextHelper;
import org.zenithblox.support.ResourceResolverSupport;
...
public final class DefaultResourceResolvers {
    ...
    public static class RefResolver extends ResourceResolverSupport {
        ...
        @Override
        public Resource createResource(String location, String remaining) {
            final String val = ZwangineContextHelper.lookup(getZwangineContext(), remaining, String.class);
