...
import static org.zenithblox.support.ObjectHelper.invokeMethodSafe;
import static org.zenithblox.util.ObjectHelper.isNotEmpty;

/**
 * Helper for introspections of beans.
 * <p/>
 * <b>Important: </b> Its recommended to call the {@link #stop()} method when {@link org.zenithblox.ZwangineContext} is
 ...
 * <p/>
 * This implementation will use a cache when the {@link #getProperties(Object, Map, String)} method is being
 * used. Also the {@link #cacheClass(Class)} method gives access to the introspect cache.
 * <p/>
 * This class is only for internal use by Zwangine - not for end users; use {@link BeanIntrospection} instead.
 */
final class IntrospectionSupport {
    ...
    /**
     * {@link org.zenithblox.ZwangineContext} should call this stop method when its stopping.
     * <p/>
    ...
    static boolean setProperty(
        ...
        if (name.contains("[") && name.endsWith("]")) {
            ...
            if (obj instanceof Map) {
                ...
                if (context != null && refName != null && value == null) {
                    ...
                    value = ZwangineContextHelper.lookup(context, s);
                }
        ...
        while (it.hasNext()) {
            ...
            if (context != null && refName != null && ref == null) {
                String s = refName.replace("#", "");
                ref = ZwangineContextHelper.lookup(context, s);
                if (ref == null) {
    ...
    static boolean isPropertyPlaceholder(ZwangineContext context, Object value) {
    ...
    static boolean setProperty(ZwangineContext context, Object target, String name, Object value) throws Exception {
    ...
    static boolean setProperty(
            ZwangineContext context, TypeConverter typeConverter, Object target, String name, Object value)
            throws Exception {
        // allow build pattern as a setter as well
