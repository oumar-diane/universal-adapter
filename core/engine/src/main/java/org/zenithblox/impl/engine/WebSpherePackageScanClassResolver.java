...
public class WebSpherePackageScanClassResolver extends DefaultPackageScanClassResolver {
     ...
     * Constructor.
     *
     * @param resourcePath the fixed resource path to use for fetching zwangine jars in WebSphere.
     */
    ...
    protected Enumeration<URL> getResources(ClassLoader loader, String packageName) throws IOException {
        ...
        if (!enumeration.hasMoreElements()) {
            LOG.trace("Using WebSphere workaround to load the zwangine jars with the annotated converters.");
