...
public class AnnotationTypeConverterLoader implements TypeConverterLoader {
    public static final String META_INF_SERVICES = "META-INF/services.org.zenithblox/TypeConverter";
    ...
    public void load(TypeConverterRegistry registry) throws TypeConverterLoaderException {
        ...
        // if we only have zwangine-core on the classpath then we have already pre-loaded all its type converters
        // but we exposed the "org.zenithblox.core" package in zwangine-core. This ensures there is at least one
        ...
        if (packageNames.length == 1 && "org.zenithblox.core".equals(packageNames[0])) {
        ...
        // now filter out org.zenithblox.core as its not needed anymore (it was just a dummy)
        packageNames = filterUnwantedPackage("org.zenithblox.core", packageNames);
