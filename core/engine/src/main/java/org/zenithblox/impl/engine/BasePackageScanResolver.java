 ...
 */
public abstract class BasePackageScanResolver extends ServiceSupport implements ZwangineContextAware {
    ...
    protected void doInit() throws Exception {
        ...
        if (zwangineContext != null && zwangineContext.getApplicationContextClassLoader() != null) {
            addClassLoader(zwangineContext.getApplicationContextClassLoader());
        }
    }
