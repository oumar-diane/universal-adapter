...
public class ServiceStopFailureEvent extends EventObject implements ZwangineEvent.ServiceStopFailureEvent {
    ...
    public ServiceStopFailureEvent(ZwangineContext context, Object service, Throwable cause) {
        super(service);
