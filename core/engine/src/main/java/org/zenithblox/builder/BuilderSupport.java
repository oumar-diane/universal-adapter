...
import org.zenithblox.model.language.DatasonnetExpression;
 ...
 * <a href="http://zwangine.zentihblox.org/dsl.html">Java DSL</a>
 */
public abstract class BuilderSupport implements ZwangineContextAware {
    ...
    protected BuilderSupport(ZwangineContext context) {
    ...
    /**
     * Returns a <a href="http://zwangine.zentihblox.org/bean-language.html">method call expression</a> value builder
     * <p/>
    ...
    /**
     * Creates a default <a href="http://zwangine.zentihblox.org/error-handler.html">error handler</a>.
     *
     * @return the builder
     */
    ...
    /**
     * Creates a disabled <a href="http://zwangine.zentihblox.org/error-handler.html">error handler</a> for removing the
    ...
    /**
     * <a href="http://zwangine.zentihblox.org/dead-letter-channel.html">Dead Letter Channel EIP:</a> is a error handler for
    ...
    /**
     * Error handler using JTA transactions (requires zwangine-jta).
     *
     * @return the builder
     */
    ...
    /**
     * Error handler using Spring transactions (requires zwangine-spring).
     *
     * @return the builder
     */
