...
public class LegacyDefaultErrorHandlerBuilder extends LegacyErrorHandlerBuilderSupport
     ...
     * @return        the builder
     */
    public LegacyDefaultErrorHandlerBuilder logger(ZwangineLogger logger) {
        setLogger(logger);
        return this;
    }
     ...
     * <tt>false</tt> to let the exception be propagated back on the {@link org.zenithblox.Exchange}. This can be used
     * in situations where you use transactions, and want to use Zwangine's dead letter channel to deal with exceptions
     ...
     * {@link org.zenithblox.Exchange}, which allows the transaction to detect the exception, and rollback.
     *
     * @param  handleNewException <tt>true</tt> to handle (and ignore), <tt>false</tt> to catch and propagated the
     *                            exception on the {@link org.zenithblox.Exchange}
     * @return                    the builder
     */
    ...
    /**
     * Sets a custom {@link Processor} to prepare the {@link org.zenithblox.Exchange} before handled by the failure
    ...
    /**
     * Sets a custom {@link Processor} to process the {@link org.zenithblox.Exchange} just after an exception was
    ...
    public Predicate getRetryWhilePolicy(ZwangineContext context) {
    ...
    protected ZwangineLogger createLogger() {
        return new ZwangineLogger(LoggerFactory.getLogger(DefaultErrorHandler.class), LoggingLevel.ERROR);
    }
