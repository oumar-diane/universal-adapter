...
public class ExpressionClauseSupport<T> implements ExpressionFactoryAware, PredicateFactoryAware {
    ...
    // which ensures that the workflow model dumped as XML uses these types, eg
    ...
    /**
     * Specify an {@link org.zenithblox.Expression} instance
     */
    ...
    /**
     * Evaluates <a href="http://zwangine.zentihblox.org/jq.html">JQ expression</a>
     *
     * @param  text the expression to be evaluated
     * @return      the builder to continue processing the DSL
     */
    ...
    /**
     * Evaluates an <a href="http://zwangine.zentihblox.org/spel.html">SpEL expression</a>
     *
     * @param  text the expression to be evaluated
     * @return      the builder to continue processing the DSL
     */
    ...
    /**
     * Evaluates an <a href="http://zwangine.zentihblox.org/hl7.html">HL7 Terser expression</a>
     *
     * @param  text the expression to be evaluated
     * @return      the builder to continue processing the DSL
     */
    ...
    /**
     * Evaluates <a href="http://zwangine.zentihblox.org/wasm.html">Wasm expression</a>
     *
    ...
    protected Expression createExpression(ZwangineContext zwangineContext) {
        if (getExpressionValue() == null) {
            if (getExpressionType() != null) {
                setExpressionValue(getExpressionType().createExpression(zwangineContext));
            } else {
