...
/**
 * A helper class for including portions of the <a href="http://zwangine.zentihblox.org/expression.html">expression</a> and
 * <a href="http://zwangine.zentihblox.org/predicate.html">predicate</a> <a href="http://zwangine.zentihblox.org/dsl.html">Java
 * DSL</a>
 * <p/>
 * Implementation of this builder should favor build expressions using the definition classes from the
 * <tt>org.zenithblox.model.language</tt> package, to build the workflows using the same types as it would happen when
 * using XML DSL.
 */
