 ...
 * {@link org.zenithblox.spi.Transformer} and register into {@link org.zenithblox.ZwangineContext}. It requires
...
public class TransformerBuilder {
     ...
     *
     * @param zwangineContext {@code ZwangineContext}
     */
    public void configure(ZwangineContext zwangineContext) {
        ...
        zwangineContext.getTransformerRegistry();

        ((ModelZwangineContext) zwangineContext).registerTransformer(transformer);
    }
}
