...
import org.zenithblox.model.MarshalDefinition;
...
/**
 * An expression for constructing the different possible {@link org.zenithblox.spi.DataFormat} options.
 */
public class DataFormatClause<T extends ProcessorDefinition<?>> {
    ...
    /**
     * {@link org.zenithblox.spi.DataFormat} operations.
     */
     ...
     * @param headersInline              define the MIME Multipart headers as part of the message body or as Zwangine
     *                                   headers
     ...
     * @param headersInline              define the MIME Multipart headers as part of the message body or as Zwangine
     *                                   headers
     * @param includeHeaders             if headersInline is set to true all zwangine headers matching this regex are also
    ...
    /**
     * Return WellFormed HTML (an XML Document) either {@link String} or {@link Node}
     */
    ...
    /**
     * Return TidyMarkup in the default format as {@link Node}
     */
    public T tidyMarkup() {
