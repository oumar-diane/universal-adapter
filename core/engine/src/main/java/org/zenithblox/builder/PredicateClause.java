...
public class PredicateClause<T> implements org.zenithblox.Predicate {
    ...
    /**
     * Define a {@link org.zenithblox.Predicate} which targets the Exchange.
     */
    ...
    /**
     * Define a {@link org.zenithblox.Predicate} which targets the Exchange In Message. <blockquote>
     *
     * <pre>
     * {@code
    ...
    /**
     * Define a {@link org.zenithblox.Predicate} which targets the Exchange In Body. <blockquote>
     *
     * <pre>
     * {@code
     * from("direct:aggregate")
    ...
    /**
     * Define a {@link org.zenithblox.Predicate} which targets the typed Exchange In Body. <blockquote>
     *
     * <pre>
     * {@code
     * from("direct:aggregate")
    ...
    /**
     * Define a {@link org.zenithblox.Predicate} which targets the Exchange In Body and its Headers. <blockquote>
     *
     * <pre>
     * {@code
     * from("direct:aggregate")
    ...
    /**
     * Define a {@link org.zenithblox.Predicate} which targets the typed Exchange In Body and its Headers.
     * <blockquote>
     *
     * <pre>
     * {@code
