...
import org.zenithblox.model.language.TokenizerExpression;

public class TokenizerExpressionReifier extends SingleInputTypedExpressionReifier<TokenizerExpression> {

    public TokenizerExpressionReifier(ZwangineContext zwangineContext, ExpressionDefinition definition) {
