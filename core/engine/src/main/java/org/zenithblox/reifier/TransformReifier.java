...
import org.zenithblox.model.TransformDefinition;
import org.zenithblox.processor.TransformProcessor;
import org.zenithblox.processor.transformer.DataTypeProcessor;

public class TransformReifier extends ExpressionReifier<TransformDefinition> {

    public TransformReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (TransformDefinition) definition);
    }
