...
public class CustomDataFormatReifier extends DataFormatReifier<CustomDataFormat> {
    ...
    public CustomDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (CustomDataFormat) definition);
    }

    @Override
    protected DataFormat doCreateDataFormat() {
        String ref = parseString(definition.getRef());
        return DataFormatReifier.getDataFormat(zwangineContext, ref);
    }
