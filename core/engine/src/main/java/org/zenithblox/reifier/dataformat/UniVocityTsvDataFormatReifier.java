...
import org.zenithblox.model.dataformat.UniVocityTsvDataFormat;

import java.util.Map;

public class UniVocityTsvDataFormatReifier extends UniVocityAbstractDataFormatReifier<UniVocityTsvDataFormat> {

    public UniVocityTsvDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
