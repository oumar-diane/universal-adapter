...
import org.zenithblox.model.errorhandler.ErrorHandlerRefProperties;
...
public class LegacyErrorHandlerRefReifier extends ErrorHandlerReifier<ErrorHandlerRefProperties> {
    ...
    public LegacyErrorHandlerRefReifier(Workflow workflow, ErrorHandlerFactory definition) {
        super(workflow, (ErrorHandlerRefProperties) definition);
    }
    ...
    private ErrorHandlerFactory lookupErrorHandler(Workflow workflow) {
        ErrorHandlerFactory handler = ErrorHandlerHelper.lookupErrorHandlerFactory(workflow, definition.getRef(), true);
