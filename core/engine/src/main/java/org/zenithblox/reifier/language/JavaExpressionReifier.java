...
import org.zenithblox.model.language.JavaExpression;

public class JavaExpressionReifier extends TypedExpressionReifier<JavaExpression> {

    public JavaExpressionReifier(ZwangineContext zwangineContext, ExpressionDefinition definition) {
    ...
    public boolean isResolveOptionalExternalScriptEnabled() {
        // we handle this in zwangine-joor (joor is used for compiling java source at runtime)
        return false;
    }
