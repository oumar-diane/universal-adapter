...
import org.zenithblox.model.dataformat.ProtobufDataFormat;
import org.zenithblox.model.dataformat.ProtobufLibrary;

import java.util.Map;

public class ProtobufDataFormatReifier extends DataFormatReifier<ProtobufDataFormat> {

    public ProtobufDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (ProtobufDataFormat) definition);
    }
