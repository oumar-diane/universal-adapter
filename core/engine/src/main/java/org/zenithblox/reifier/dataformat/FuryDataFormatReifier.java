...
import org.zenithblox.model.dataformat.FuryDataFormat;

import java.util.Map;

public class FuryDataFormatReifier extends DataFormatReifier<FuryDataFormat> {
    public FuryDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (FuryDataFormat) definition);
    }
    ...
    protected void prepareDataFormatConfig(Map<String, Object> properties) {
        ...
        properties.put("allowAutoWiredFury", definition.getAllowAutoWiredFury());
    }
}
