...
import org.zenithblox.support.processor.MarshalProcessor;

public class MarshalReifier extends ProcessorReifier<MarshalDefinition> {

    public MarshalReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (MarshalDefinition) definition);
    }
