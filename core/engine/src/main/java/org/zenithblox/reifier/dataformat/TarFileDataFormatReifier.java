...
import org.zenithblox.model.dataformat.TarFileDataFormat;

import java.util.Map;

public class TarFileDataFormatReifier extends DataFormatReifier<TarFileDataFormat> {

    public TarFileDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (TarFileDataFormat) definition);
    }
