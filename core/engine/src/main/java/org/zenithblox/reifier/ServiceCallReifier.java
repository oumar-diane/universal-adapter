...
public class ServiceCallReifier extends ProcessorReifier<ServiceCallDefinition> {
    ...
    public ServiceCallReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, ServiceCallDefinition.class.cast(definition));
    }

    @Override
    public Processor createProcessor() throws Exception {
        throw new IllegalStateException("Cannot find zwangine-cloud on the classpath.");
    }
