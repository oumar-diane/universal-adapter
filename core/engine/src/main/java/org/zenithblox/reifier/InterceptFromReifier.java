...
import org.zenithblox.model.InterceptFromDefinition;
...
public class InterceptFromReifier extends ProcessorReifier<InterceptFromDefinition> {
    ...
    public InterceptFromReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (InterceptFromDefinition) definition);
    }
    ...
    public Processor createProcessor() throws Exception {
        ...
        return new FilterProcessor(getZwangineContext(), when, Pipeline.newInstance(getZwangineContext(), p, child));
    }
