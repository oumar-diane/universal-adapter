...
import org.zenithblox.processor.SetHeaderProcessor;
...
public class SetHeaderReifier extends ExpressionReifier<SetHeaderDefinition> {
    ...
    public SetHeaderReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (SetHeaderDefinition) definition);
    }
