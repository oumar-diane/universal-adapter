...
import org.zenithblox.model.dataformat.BarcodeDataFormat;

import java.util.Map;

public class BarcodeDataFormatReifier extends DataFormatReifier<BarcodeDataFormat> {

    public BarcodeDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (BarcodeDataFormat) definition);
    }
