...
import org.zenithblox.model.dataformat.ASN1DataFormat;

import java.util.Map;

public class ASN1DataFormatReifier extends DataFormatReifier<ASN1DataFormat> {

    public ASN1DataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (ASN1DataFormat) definition);
    }
