...
import org.zenithblox.model.dataformat.SoapDataFormat;

import java.util.Map;

public class SoapDataFormatReifier extends DataFormatReifier<SoapDataFormat> {

    public SoapDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (SoapDataFormat) definition);
    }
