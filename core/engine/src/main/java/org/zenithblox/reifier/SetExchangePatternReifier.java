...
import org.zenithblox.model.SetExchangePatternDefinition;
import org.zenithblox.processor.ExchangePatternProcessor;

public class SetExchangePatternReifier extends ProcessorReifier<SetExchangePatternDefinition> {

    public SetExchangePatternReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (SetExchangePatternDefinition) definition);
    }
