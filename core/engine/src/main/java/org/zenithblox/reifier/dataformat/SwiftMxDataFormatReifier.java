...
import org.zenithblox.model.dataformat.SwiftMxDataFormat;

import java.util.Map;

public class SwiftMxDataFormatReifier extends DataFormatReifier<SwiftMxDataFormat> {

    public SwiftMxDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (SwiftMxDataFormat) definition);
    }
