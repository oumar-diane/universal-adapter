...
import org.zenithblox.model.ConvertHeaderDefinition;
import org.zenithblox.model.ProcessorDefinition;
import org.zenithblox.support.LanguageSupport;
import org.zenithblox.support.processor.ConvertHeaderProcessor;

import java.nio.charset.UnsupportedCharsetException;

public class ConvertHeaderReifier extends ProcessorReifier<ConvertHeaderDefinition> {

    public ConvertHeaderReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, ConvertHeaderDefinition.class.cast(definition));
    }
