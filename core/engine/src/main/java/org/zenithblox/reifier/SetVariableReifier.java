...
import org.zenithblox.processor.SetVariableProcessor;
...
public class SetVariableReifier extends ExpressionReifier<SetVariableDefinition> {
    ...
    public SetVariableReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (SetVariableDefinition) definition);
    }
