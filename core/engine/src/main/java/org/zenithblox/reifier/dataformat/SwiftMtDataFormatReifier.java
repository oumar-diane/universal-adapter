...
import org.zenithblox.model.dataformat.SwiftMtDataFormat;

import java.util.Map;

public class SwiftMtDataFormatReifier extends DataFormatReifier<SwiftMtDataFormat> {

    public SwiftMtDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (SwiftMtDataFormat) definition);
    }
