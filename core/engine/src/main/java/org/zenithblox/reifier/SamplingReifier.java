...
import org.zenithblox.model.SamplingDefinition;
import org.zenithblox.processor.SamplingThrottler;

import java.util.concurrent.TimeUnit;

public class SamplingReifier extends ProcessorReifier<SamplingDefinition> {

    public SamplingReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (SamplingDefinition) definition);
    }
