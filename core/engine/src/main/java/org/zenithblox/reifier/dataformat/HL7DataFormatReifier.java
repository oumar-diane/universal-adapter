...
import org.zenithblox.model.dataformat.HL7DataFormat;

import java.util.Map;

public class HL7DataFormatReifier extends DataFormatReifier<HL7DataFormat> {

    public HL7DataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (HL7DataFormat) definition);
    }
