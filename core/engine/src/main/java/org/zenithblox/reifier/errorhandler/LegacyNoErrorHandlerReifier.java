...
import org.zenithblox.model.errorhandler.NoErrorHandlerProperties;
...
public class LegacyNoErrorHandlerReifier extends ErrorHandlerReifier<NoErrorHandlerProperties> {
    ...
    public LegacyNoErrorHandlerReifier(Workflow workflow, ErrorHandlerFactory definition) {
        super(workflow, (NoErrorHandlerProperties) definition);
    }
