...
import org.zenithblox.model.dataformat.BeanioDataFormat;

import java.util.Map;

public class BeanioDataFormatReifier extends DataFormatReifier<BeanioDataFormat> {

    public BeanioDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (BeanioDataFormat) definition);
    }
