...
import org.zenithblox.model.loadbalancer.TopicLoadBalancerDefinition;
import org.zenithblox.processor.loadbalancer.LoadBalancer;
import org.zenithblox.processor.loadbalancer.TopicLoadBalancer;

public class TopicLoadBalancerReifier extends LoadBalancerReifier<TopicLoadBalancerDefinition> {

    public TopicLoadBalancerReifier(Workflow workflow, LoadBalancerDefinition definition) {
        super(workflow, (TopicLoadBalancerDefinition) definition);
    }
