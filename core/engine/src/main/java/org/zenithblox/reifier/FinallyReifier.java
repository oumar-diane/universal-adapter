...
import org.zenithblox.processor.FinallyProcessor;

public class FinallyReifier extends ProcessorReifier<FinallyDefinition> {

    public FinallyReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, FinallyDefinition.class.cast(definition));
    }
