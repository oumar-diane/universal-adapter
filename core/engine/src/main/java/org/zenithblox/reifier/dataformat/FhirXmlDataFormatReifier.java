...
import org.zenithblox.model.dataformat.FhirXmlDataFormat;

public class FhirXmlDataFormatReifier extends FhirDataFormatReifier<FhirXmlDataFormat> {

    public FhirXmlDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
