...
import org.zenithblox.model.dataformat.Base64DataFormat;

import java.util.Map;

public class Base64DataFormatReifier extends DataFormatReifier<Base64DataFormat> {

    public Base64DataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (Base64DataFormat) definition);
    }
