...
public class DefaultErrorHandlerReifier extends ErrorHandlerReifier<DefaultErrorHandlerDefinition> {
    ...
    public DefaultErrorHandlerReifier(Workflow workflow, DefaultErrorHandlerDefinition definition) {
    ...
    private ZwangineLogger resolveLogger(DefaultErrorHandlerDefinition definition) {
        ...
        if (answer == null) {
            answer = new ZwangineLogger(LoggerFactory.getLogger(DefaultErrorHandler.class), LoggingLevel.ERROR);
        }
    ...
    private RedeliveryPolicy resolveRedeliveryPolicy(DefaultErrorHandlerDefinition definition, ZwangineContext zwangineContext) {
