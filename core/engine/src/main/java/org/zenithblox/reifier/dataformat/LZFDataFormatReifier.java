...
import org.zenithblox.model.dataformat.LZFDataFormat;

import java.util.Map;

public class LZFDataFormatReifier extends DataFormatReifier<LZFDataFormat> {

    public LZFDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (LZFDataFormat) definition);
    }
