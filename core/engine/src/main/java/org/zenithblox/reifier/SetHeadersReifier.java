...
import org.zenithblox.model.SetHeaderDefinition;
import org.zenithblox.model.SetHeadersDefinition;
import org.zenithblox.processor.SetHeadersProcessor;
...
public class SetHeadersReifier extends ProcessorReifier<SetHeadersDefinition> {
    ...
    public SetHeadersReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (SetHeadersDefinition) definition);
    }
