...
import org.zenithblox.model.dataformat.IcalDataFormat;

import java.util.Map;

public class IcalDataFormatReifier extends DataFormatReifier<IcalDataFormat> {

    public IcalDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (IcalDataFormat) definition);
    }
