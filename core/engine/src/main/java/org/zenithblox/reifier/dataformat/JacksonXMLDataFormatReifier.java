...
import org.zenithblox.model.dataformat.JacksonXMLDataFormat;

import java.util.Map;

public class JacksonXMLDataFormatReifier extends DataFormatReifier<JacksonXMLDataFormat> {

    public JacksonXMLDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (JacksonXMLDataFormat) definition);
    }
