...
import org.zenithblox.processor.StopProcessor;

public class StopReifier extends ProcessorReifier<StopDefinition> {

    public StopReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (StopDefinition) definition);
    }
