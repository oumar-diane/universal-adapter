...
import org.zenithblox.model.dataformat.ZipDeflaterDataFormat;

import java.util.Map;

public class ZipDataFormatReifier extends DataFormatReifier<ZipDeflaterDataFormat> {

    public ZipDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (ZipDeflaterDataFormat) definition);
    }
