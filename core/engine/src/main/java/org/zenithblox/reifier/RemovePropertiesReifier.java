...
import org.zenithblox.model.RemovePropertiesDefinition;
import org.zenithblox.processor.RemovePropertiesProcessor;
...
public class RemovePropertiesReifier extends ProcessorReifier<RemovePropertiesDefinition> {
    ...
    public RemovePropertiesReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (RemovePropertiesDefinition) definition);
    }
