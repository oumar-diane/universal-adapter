...
import org.zenithblox.model.SetBodyDefinition;
import org.zenithblox.processor.SetBodyProcessor;

public class SetBodyReifier extends ExpressionReifier<SetBodyDefinition> {

    public SetBodyReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (SetBodyDefinition) definition);
    }
