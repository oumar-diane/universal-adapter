...
import org.zenithblox.model.LoopDefinition;
import org.zenithblox.model.ProcessorDefinition;
import org.zenithblox.processor.LoopProcessor;

public class LoopReifier extends ExpressionReifier<LoopDefinition> {

    public LoopReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (LoopDefinition) definition);
    }
    ...
    public Processor createProcessor() throws Exception {
        ...
        return new LoopProcessor(zwangineContext, output, expression, predicate, prepare, isCopy, isBreakOnShutdown);
    }
