...
import org.zenithblox.model.dataformat.JsonApiDataFormat;

import java.util.Map;

public class JsonApiDataFormatReifier extends DataFormatReifier<JsonApiDataFormat> {

    public JsonApiDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (JsonApiDataFormat) definition);
    }
