...
import org.zenithblox.model.dataformat.UniVocityFixedDataFormat;
...
public class UniVocityFixedWidthDataFormatReifier extends UniVocityAbstractDataFormatReifier<UniVocityFixedDataFormat> {
    ...
    public UniVocityFixedWidthDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
