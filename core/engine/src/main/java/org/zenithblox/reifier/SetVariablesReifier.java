...
import org.zenithblox.model.SetVariableDefinition;
import org.zenithblox.model.SetVariablesDefinition;
import org.zenithblox.processor.SetVariablesProcessor;
...
public class SetVariablesReifier extends ProcessorReifier<SetVariablesDefinition> {
    ...
    public SetVariablesReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (SetVariablesDefinition) definition);
    }
