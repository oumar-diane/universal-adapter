...
import org.zenithblox.model.dataformat.ParquetAvroDataFormat;

import java.util.Map;

public class ParquetAvroDataFormatReifier extends DataFormatReifier<ParquetAvroDataFormat> {

    public ParquetAvroDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (ParquetAvroDataFormat) definition);
    }
