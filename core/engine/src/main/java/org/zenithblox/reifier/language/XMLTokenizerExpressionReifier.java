...
import org.zenithblox.model.language.XMLTokenizerExpression;
...
public class XMLTokenizerExpressionReifier extends SingleInputTypedExpressionReifier<XMLTokenizerExpression> {
    ...
    public XMLTokenizerExpressionReifier(ZwangineContext zwangineContext, ExpressionDefinition definition) {
