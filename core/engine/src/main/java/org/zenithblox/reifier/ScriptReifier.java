...
import org.zenithblox.model.ScriptDefinition;
import org.zenithblox.processor.ScriptProcessor;

public class ScriptReifier extends ExpressionReifier<ScriptDefinition> {

    public ScriptReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (ScriptDefinition) definition);
    }
