...
import org.zenithblox.model.dataformat.ThriftDataFormat;

import java.util.Map;

public class ThriftDataFormatReifier extends DataFormatReifier<ThriftDataFormat> {

    public ThriftDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (ThriftDataFormat) definition);
    }
