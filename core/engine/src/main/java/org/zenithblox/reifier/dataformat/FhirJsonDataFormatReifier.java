...
import org.zenithblox.model.dataformat.FhirJsonDataFormat;

public class FhirJsonDataFormatReifier extends FhirDataFormatReifier<FhirJsonDataFormat> {

    public FhirJsonDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
