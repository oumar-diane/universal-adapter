...
import org.zenithblox.model.dataformat.UniVocityAbstractDataFormat;
import org.zenithblox.model.dataformat.UniVocityHeader;
...
public class UniVocityAbstractDataFormatReifier<T extends UniVocityAbstractDataFormat> extends DataFormatReifier<T> {
    ...
    public UniVocityAbstractDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
