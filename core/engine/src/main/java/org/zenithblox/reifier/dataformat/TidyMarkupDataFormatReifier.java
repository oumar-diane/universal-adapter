...
import org.zenithblox.model.dataformat.TidyMarkupDataFormat;

import java.util.Map;

public class TidyMarkupDataFormatReifier extends DataFormatReifier<TidyMarkupDataFormat> {

    public TidyMarkupDataFormatReifier(ZwangineContext zwangineContext, DataFormatDefinition definition) {
        super(zwangineContext, (TidyMarkupDataFormat) definition);
    }
