...
import org.zenithblox.model.SetPropertyDefinition;
import org.zenithblox.processor.SetPropertyProcessor;
...
public class SetPropertyReifier extends ExpressionReifier<SetPropertyDefinition> {
    ...
    public SetPropertyReifier(Workflow workflow, ProcessorDefinition<?> definition) {
        super(workflow, (SetPropertyDefinition) definition);
    }
