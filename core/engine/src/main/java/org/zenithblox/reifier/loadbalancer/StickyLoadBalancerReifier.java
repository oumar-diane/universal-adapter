...
import org.zenithblox.model.loadbalancer.StickyLoadBalancerDefinition;
import org.zenithblox.processor.loadbalancer.LoadBalancer;
import org.zenithblox.processor.loadbalancer.StickyLoadBalancer;

public class StickyLoadBalancerReifier extends LoadBalancerReifier<StickyLoadBalancerDefinition> {

    public StickyLoadBalancerReifier(Workflow workflow, LoadBalancerDefinition definition) {
        super(workflow, (StickyLoadBalancerDefinition) definition);
    }
