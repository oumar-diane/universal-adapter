...
public final class SimpleExpressionBuilder {
    ...
    public static Expression messageHistoryExpression(final boolean detailed) {
        return new ExpressionAdapter() {
            ...
            private ExchangeFormatter getOrCreateExchangeFormatter(ZwangineContext zwangineContext) {
                return LanguageHelper.getOrCreateExchangeFormatter(zwangineContext, formatter);
            }
        ...
        return new ExpressionAdapter() {
            ...
            public void init(ZwangineContext context) {
                if ("classic".equalsIgnoreCase(generator)) {
                    ...
                    uuid = ZwangineContextHelper.mandatoryLookup(context, generator, UuidGenerator.class);
                }
            }
    ...
    public static Expression fileParentExpression() {
        return new ExpressionAdapter() {
            @Override
            public Object evaluate(Exchange exchange) {
                return exchange.getIn().getHeader("ZwangineFileParent", String.class);
            }
    ...
    public static Expression filePathExpression() {
        return new ExpressionAdapter() {
            @Override
            public Object evaluate(Exchange exchange) {
                return exchange.getIn().getHeader("ZwangineFilePath", String.class);
            }
    ...
    public static Expression fileAbsolutePathExpression() {
        return new ExpressionAdapter() {
            @Override
            public Object evaluate(Exchange exchange) {
                return exchange.getIn().getHeader("ZwangineFileAbsolutePath", String.class);
            }
    ...
    public static Expression fileAbsoluteExpression() {
        return new ExpressionAdapter() {
            @Override
            public Object evaluate(Exchange exchange) {
                return exchange.getIn().getHeader("ZwangineFileAbsolute", Boolean.class);
            }
    ...
    /**
     * Returns the expression for the exchanges zwangineContext invoking methods defined in a simple OGNL notation
     *
     * @param ognl methods to invoke on the context in a simple OGNL syntax
     */
    public static Expression zwangineContextOgnlExpression(final String ognl) {
        return new ExpressionAdapter() {
            private Expression exp;
            ...
            @Override
            public String toString() {
                return "zwangineContextOgnl(" + ognl + ")";
            }
        };
    }
                ...
                if (pos > 0) {
                    ...
                    if (type != null) {
                        ...
                        if (type.isEnum()) {
                            ...
                            throw ZwangineExecutionException.wrapZwangineExecutionException(exchange,
