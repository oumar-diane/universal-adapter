...
public interface SimpleNode {
     ...
     * @throws SimpleParserException should be thrown if error parsing the model
     */
    Expression createExpression(ZwangineContext zwangineContext, String expression) throws SimpleParserException;
     ...
     * @throws SimpleParserException should be thrown if error parsing the model
     */
    String createCode(ZwangineContext zwangineContext, String expression) throws SimpleParserException;
