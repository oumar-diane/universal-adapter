...
import org.zenithblox.language.simple.SimplePredicateParser;
...
public class CSimplePredicateParser {
    ...
    public String parsePredicate(ZwangineContext zwangineContext, String predicate) {
        // reuse simple language parser but output the result as java code
        SimplePredicateParser parser = new SimplePredicateParser(zwangineContext, predicate, true, null);
