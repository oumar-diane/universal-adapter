...
/**
 * A set of helper as static imports for the Zwangine compiled simple language.
 */
public final class CSimpleHelper {
    ...
    private static <T> T tryCast(ZwangineContext context, Class<T> type, String key, Object obj) {
    ...
    public static String fromWorkflowId(Exchange exchange) {
    ...
    public static String fileParent(Message message) {
        return message.getHeader("ZwangineFileParent", String.class);
    }

    public static String filePath(Message message) {
        return message.getHeader("ZwangineFilePath", String.class);
    }

    public static Boolean fileAbsolute(Message message) {
        return message.getHeader("ZwangineFileAbsolute", Boolean.class);
    }

    public static String fileAbsolutePath(Message message) {
        return message.getHeader("ZwangineFileAbsolutePath", String.class);
    }
    ...
    public static Object increment(Exchange exchange, Object number) {
        ...
        if (num instanceof Integer) {
            ...
            Exception cause = new ZwangineExchangeException("Cannot evaluate message body as a number", exchange);
    ...
    public static SkipIterator skip(Exchange exchange, Object skip) {
        ...
        Iterator<?> it = org.zenithblox.support.ObjectHelper.createIterator(exchange.getMessage().getBody());
    ...
    private static ExchangeFormatter getOrCreateExchangeFormatter(ZwangineContext zwangineContext) {
        return LanguageHelper.getOrCreateExchangeFormatter(zwangineContext, exchangeFormatter);
    }

    public static boolean isEqualTo(Exchange exchange, Object leftValue, Object rightValue) {
        return org.zenithblox.support.ObjectHelper.typeCoerceEquals(exchange.getContext().getTypeConverter(), leftValue,
                rightValue);
    }
    ...
    public static boolean isNotEqualTo(Exchange exchange, Object leftValue, Object rightValue) {
        return org.zenithblox.support.ObjectHelper.typeCoerceNotEquals(exchange.getContext().getTypeConverter(), leftValue,
                rightValue);
    }

    public static boolean isGreaterThan(Exchange exchange, Object leftValue, Object rightValue) {
        return org.zenithblox.support.ObjectHelper.typeCoerceCompare(exchange.getContext().getTypeConverter(), leftValue,
                rightValue)
               > 0;
    }
    ...
    public static boolean contains(Exchange exchange, Object leftValue, Object rightValue) {
        ...
        return org.zenithblox.support.ObjectHelper.typeCoerceContains(exchange.getContext().getTypeConverter(), leftValue,
                rightValue, false);
    }
    ...
    public static boolean in(Exchange exchange, Object leftValue, Object rightValue) {
        ...
        Iterator<?> it = org.zenithblox.support.ObjectHelper.createIterator(rightValue);
    ...
    private static Object doObjectAsIndex(ZwangineContext context, Object obj, String key) {
    ...
    private static Integer indexAsNumber(ZwangineContext context, String key, int size) {
        Integer num;
    ...
    public static UuidGenerator customUuidGenerator(Exchange exchange, String generator) {
        return ZwangineContextHelper.mandatoryLookup(exchange.getContext(), generator, UuidGenerator.class);
    }
}
