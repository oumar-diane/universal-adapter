...
/**
 * Channel acts as a channel between {@link Processor}s in the workflow graph.
 * <p/>
 * The channel is responsible for routing the {@link Exchange} to the next {@link Processor} in the workflow graph.
 */
public interface Channel extends AsyncProcessor, Navigate<Processor> {
     ...
     *
     * @return the output to workflow the {@link Exchange} to
     */
    Processor getOutput();

    /**
     * Gets the next {@link Processor} to workflow to (not wrapped)
     *
