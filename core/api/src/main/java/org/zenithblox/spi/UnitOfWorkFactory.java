...
import org.zenithblox.AfterPropertiesConfigured;
import org.zenithblox.ZwangineContext;
import org.zenithblox.Exchange;

/**
 * Factory to create {@link org.zenithblox.spi.UnitOfWork}.
 *
 ...
 * org.zenithblox.impl.engine.DefaultUnitOfWork to ensure Zwangine functionality works correctly during routing of
 * {@link Exchange}s.
 */
public interface UnitOfWorkFactory extends AfterPropertiesConfigured {
    ...
    @Override
    default void afterPropertiesConfigured(ZwangineContext zwangineContext) {
        // noop
    }
