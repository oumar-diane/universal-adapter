 ...
 * {@link org.zenithblox.ZwangineContext#setTypeConverterStatisticsEnabled(Boolean)} (boolean)} method.
 */
public interface TypeConverterRegistry extends StaticService, ZwangineContextAware {
     ...
     * <p/>
     * This method may throw {@link org.zenithblox.TypeConverterExistsException} if configured to fail if an existing
     ...
     * with {@link org.zenithblox.Converter}.
     *
