...
/**
 * To record {@link StartupStep} during startup to allow to capture diagnostic information to help troubleshoot Zwangine
...
public interface StartupStepRecorder extends StaticService {
     ...
     *
     * Use 0 (default) to stop the recorder after Zwangine has been started. Use -1 to keep the recorder running until
     * Zwangine is being stopped. A positive value is to run the recorder for N seconds.
     */
    ...
    /**
     * Whether to start flight recorder recording. This is only in use if zwangine-jfr is being used.
     */
