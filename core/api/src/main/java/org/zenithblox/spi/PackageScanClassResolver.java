...
public interface PackageScanClassResolver extends StaticService {
    ...
    /**
     * Attempts to discover classes that are assignable to the type provided (exclude abstract classes). In the case
     * that an interface is provided this method will collect implementations. In the case of a non-interface class,
