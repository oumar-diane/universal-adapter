...
public interface BacklogTracer {
    ...
    /**
     * Filter for tracing by workflow or node id
     */
    ...
    /**
     * Dumps tracing data for the given workflow id / node id
     */
    ...
    /**
     * Dumps tracing data for the given workflow id / node id as XML
     */
    ...
    /**
     * Dumps tracing data for the given workflow id / node id as JSon
     */
