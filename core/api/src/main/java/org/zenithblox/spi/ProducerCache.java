...
public interface ProducerCache extends Service {
     ...
     * {@link #releaseProducer(Endpoint, AsyncProducer)} method.
     * <p/>
     ...
     * @throws RejectedExecutionException is thrown if ZwangineContext is stopped
     */
    ...
    /**
     * Whether {@link org.zenithblox.spi.EventNotifier} is enabled
     */
    boolean isEventNotifierEnabled();

    /**
     * Sets whether {@link org.zenithblox.spi.EventNotifier} is enabled
     */
     ...
     * <p/>
     * Using this callback as a template pattern ensures that Zwangine handles the resource handling and will start and
