 ...
 *
 * End users should favour using {@link org.zenithblox.support.PropertyBindingSupport} instead.
 */
public interface BeanIntrospection extends StaticService, AfterPropertiesConfigured {
     ...
     */
    boolean setProperty(ZwangineContext context, Object target, String name, Object value) throws Exception;
