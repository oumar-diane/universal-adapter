...
/**
 * A specialized {@link org.zenithblox.spi.AggregationRepository} which also supports optimistic locking.
 *
 * If the underlying implementation cannot perform optimistic locking, it should not implement this interface.
 *
 * @see org.zenithblox.processor.aggregate.MemoryAggregationRepository
 */
public interface OptimisticLockingAggregationRepository extends AggregationRepository {

    /**
     * {@link Exception} used by an {@code AggregationRepository} to indicate that an optimistic update error has
    ...
    /**
     * Add the given {@link org.zenithblox.Exchange} under the correlation key.
     * <p/>
     ...
     * returning from {@link AggregationRepository#get(ZwangineContext, String)}} and retrieved from the
     * exchange when passed to
     * {@link AggregationRepository#add(ZwangineContext, String, org.zenithblox.Exchange)}.
     * <p/>
     * Note: The {@link org.zenithblox.processor.aggregate.MemoryAggregationRepository} is an exception to this
     ...
     * <p/>
     * The {@link org.zenithblox.processor.aggregate.AggregateProcessor} will ensure that the exchange received from
     * {@link OptimisticLockingAggregationRepository#get(ZwangineContext, String)} is passed as
     * {@code oldExchange}, and that the aggregated exchange received from the
     * {@link org.zenithblox.processor.aggregate.AggregationStrategy} is passed as the {@code newExchange}.
     *
     ...
     */
    Exchange add(ZwangineContext zwangineContext, String key, Exchange oldExchange, Exchange newExchange)
     ...
     */
    @Override
    void remove(ZwangineContext zwangineContext, String key, Exchange exchange) throws OptimisticLockingException;
}
