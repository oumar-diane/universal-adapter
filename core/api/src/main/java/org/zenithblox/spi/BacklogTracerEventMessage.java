...
public interface BacklogTracerEventMessage {
    ...
    /**
     * Whether this event was from a workflow that is created from Rest DSL.
     */
    boolean isRest();

    /**
     * Whether this event was from a workflow that is created from workflow template or kamelet.
     */
    boolean isTemplate();

    /**
     * Node id where the message is being workflowd to
     */
    String getToNode();
    ...
    /**
     * The endpoint uri if this trace is either from a workflow input (from), or the exchange was sent to an endpoint such
    ...
    /**
     * The event message as an org.zenithblox.util.json.JsonObject object.
     */
