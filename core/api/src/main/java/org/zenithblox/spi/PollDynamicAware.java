...
/**
 * Used for components that can optimise the usage of {@link org.zenithblox.processor.PollProcessor} (poll/pollEnrich)
 * to reuse a static {@link Endpoint} and {@link org.zenithblox.DynamicPollingConsumer} that supports using headers to
 * provide the dynamic parts. For example many of the file based components supports this.
 */
public interface PollDynamicAware extends Service, ZwangineContextAware {
     ...
     * {@link org.zenithblox.DynamicPollingConsumer} that will be reused for processing the optimised poll/pollEnrich.
     *
     * @param  exchange  the exchange
