...
public interface AsyncProcessorAwaitManager extends StaticService {
    ...
    interface AwaitThread {
        ...
        /**
         * The id of the workflow where the exchange was processed when the thread was set to block.
         * <p/>
        ...
        /**
         * The id of the node from the workflow where the exchange was processed when the thread was set to block.
         * <p/>
         * Is <tt>null</tt> if message history is disabled.
         */
        String getNodeId();
     ...
     * count-down so the blocked thread can continue. An exception is set on the exchange which allows Zwangine's error
     ...
     * <p/>
     * This is enabled by default which allows Zwangine to release any blocked thread during shutting down Zwangine itself.
     */
