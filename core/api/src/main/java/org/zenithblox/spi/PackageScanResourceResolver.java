 ...
 *
 * OSGi is not supported as this is intended for standalone Zwangine runtimes such as Zwangine Main, or Zwangine Quarkus.
 *
...
public interface PackageScanResourceResolver extends StaticService {
     ...
     * <p/>
     * This implementation will return a new unmodifiable set containing the classloaders. Use the
     * {@link #addClassLoader(ClassLoader)} method if you want to add new classloaders to the class loaders list.
     *
     ...
     *
     * Wildcards is supported using an ANT pattern style paths, such as classpath:&#42;&#42;/&#42;zwangine&#42;.xml
     *
     ...
     *
     * @param  location  the location (support ANT style patterns, eg workflows/zwangine-*.xml)
