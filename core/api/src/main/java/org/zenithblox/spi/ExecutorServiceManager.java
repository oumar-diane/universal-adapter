 ...
 * {@link org.zenithblox.impl.DefaultExecutorServiceManager}, if that is sufficient. The {@link ThreadPoolFactory} is
 * always used for creating the actual thread pools. You can implement a custom {@link ThreadPoolFactory} to leverage
 * the WorkManager for a JEE server.
 * <p/>
 * The {@link ThreadPoolFactory} has pure JDK API, where as this {@link ExecutorServiceManager} has Zwangine API concepts
 * such as {@link ThreadPoolProfile}. Therefore it may be easier to only implement a custom {@link ThreadPoolFactory}.
 * <p/>
 ...
 * <p/>
 * If you use the <tt>newXXX</tt> methods to create thread pools, then Zwangine will by default take care of shutting down
 * those created pools when {@link org.zenithblox.ZwangineContext} is shutting down.
 * <p/>
 * For more information about shutting down thread pools see the {@link #shutdown(ExecutorService)}
 * and {@link #shutdownNow(ExecutorService)}, and {@link #getShutdownAwaitTermination()} methods.
...
public interface ExecutorServiceManager extends ShutdownableService, StaticService {
    ...
    interface ThreadFactoryListener {
        ...
        /**
         * Listener when Zwangine has created a new {@link ThreadFactory} to be used by this
     ...
     * <p/>
     * The default pattern is: <tt>Zwangine (#zwangineId#) thread ##counter# - #name#</tt>
     * <p/>
     * Where <tt>#zwangineId#</tt> is the name of the {@link org.zenithblox.ZwangineContext} <br/>
     ...
     * {@link ExecutorService#shutdown()} and return.
     *
     ...
     * aggressively by doing a {@link #shutdownNow(ExecutorService)} which forces a shutdown. The
     ...
     * {@link ExecutorService#shutdownNow()} and return.
     *
