 ...
 * <p/>
 * The scheme can also be used to associate the same DataType with different Zwangine components. For example
...
public class DataType {
    ...
    public static final String DEFAULT_SCHEME = "zwangine";
