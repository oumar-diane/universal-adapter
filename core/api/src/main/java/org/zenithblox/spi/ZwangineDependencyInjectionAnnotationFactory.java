...
/**
 * A factory which performs the task from Zwangine dependency injection annotations on a field, property or method
 * parameter of a specified type.
 */
public interface ZwangineDependencyInjectionAnnotationFactory {

    /**
     * The task for binding the bean to the registry (eg {@link org.zenithblox.BindToRegistry annotation}
     *
