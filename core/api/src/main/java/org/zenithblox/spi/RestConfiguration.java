...
/**
 * Configuration use by {@link org.zenithblox.spi.RestConsumerFactory} and
 * {@link org.zenithblox.spi.RestApiConsumerFactory} for Zwangine components to support the Zwangine
 * {@link org.zenithblox.model.rest.RestDefinition rest} DSL.
 */
public class RestConfiguration {
    ...
    private boolean inlineWorkflows = true;
    ...
    /**
     * Gets the name of the Zwangine component to use as the REST consumer
     *
     * @return the component name, or <tt>null</tt> to let Zwangine search the {@link Registry} to find suitable
     *         implementation
     */
    ...
    /**
     * Sets the name of the Zwangine component to use as the REST consumer
     *
    ...
    /**
     * Gets the name of the Zwangine component to use as the REST API (such as swagger or openapi).
     *
    ...
    /**
     * Sets the name of the Zwangine component to use as the REST API (such as swagger or openapi)
     *
    ...
    /**
     * Gets the name of the Zwangine component to use as the REST producer
     *
     * @return the component name, or <tt>null</tt> to let Zwangine search the {@link Registry} to find suitable
     *         implementation
     */
     ...
     * parameters are valid accordingly to the api document. This requires adding zwangine-openapi-java to the classpath,
     * and any miss configuration will let Zwangine fail on startup and report the error(s).
     * <p/>
    ...
    public boolean isInlineWorkflows() {
     ...
     * This option is default <tt>true</tt>.
     */
    public void setInlineWorkflows(boolean inlineWorkflows) {
