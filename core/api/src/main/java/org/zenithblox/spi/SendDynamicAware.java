...
/**
 * Used for components that can optimise the usage of {@link org.zenithblox.processor.SendDynamicProcessor} (toD) to
 * reuse a static {@link Endpoint} and {@link Producer} that supports using headers to provide the
 * dynamic parts. For example many of the HTTP components supports this.
 */
public interface SendDynamicAware extends Service, ZwangineContextAware {
