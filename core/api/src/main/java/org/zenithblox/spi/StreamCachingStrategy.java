...
/**
 * Strategy for using <a href="http://zwangine.zwangine.org/stream-caching.html">stream caching</a>.
 */
public interface StreamCachingStrategy extends StaticService {
     ...
     * <p/>
     * The default threshold is {@link StreamCache#DEFAULT_SPOOL_THRESHOLD} bytes (eg 128kb). Use
     ...
     * <p/>
     * The default size is {@link org.zenithblox.util.IOHelper#DEFAULT_BUFFER_SIZE}
     */
    ...
    /**
     * Sets whether if just any of the {@link org.zenithblox.spi.StreamCachingStrategy.SpoolRule} rules returns
     * <tt>true</tt> then {@link #shouldSpoolCache(long)} returns <tt>true</tt>. If this option is <tt>false</tt>, then
     * <b>all</b> the {@link org.zenithblox.spi.StreamCachingStrategy.SpoolRule} must return <tt>true</tt>.
     * <p/>
    ...
    /**
     * Adds the {@link org.zenithblox.spi.StreamCachingStrategy.SpoolRule} rule to be used.
     */
