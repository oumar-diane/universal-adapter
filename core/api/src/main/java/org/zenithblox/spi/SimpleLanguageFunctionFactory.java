...
public interface SimpleLanguageFunctionFactory {
     ...
     */
    Expression createFunction(ZwangineContext zwangineContext, String function, int index);
     ...
     */
    String createCode(ZwangineContext zwangineContext, String function, int index);
