...
public interface ModelToYAMLDumper {
     ...
     */
    String dumpModelAsYaml(ZwangineContext context, NamedNode definition) throws Exception;
     ...
     * @throws Exception is throw if error marshalling to YAML
     */
    String dumpBeansAsYaml(ZwangineContext context, List<Object> beans) throws Exception;
     ...
     * @throws Exception   is throw if error marshalling to YAML
     */
    String dumpDataFormatsAsYaml(ZwangineContext context, Map<String, Object> dataFormats) throws Exception;
