...
/**
 * Bulk type converters that often comes out of the box with  Zwangine. Zwangine does a build phase where the Zwangine
 * artifacts are scanned for {@link org.zenithblox.Converter}s and then bulked together into a single source code
