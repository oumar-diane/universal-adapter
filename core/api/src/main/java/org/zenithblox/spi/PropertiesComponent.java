...
public interface PropertiesComponent extends StaticService {
     ...
     * Properties props = pc.loadProperties(key -> key.startsWith("zwangine.component.seda"));
     * </pre>
     *
     ...
     * <pre>
     * PropertiesComponent pc = getPropertiesComponent();
     * Properties props = pc.loadProperties(key -> key.startsWith("zwangine.component.seda"), StringHelper::dashToZwangineCase);
     * </pre>
     *
     * @param  filter    the predicate used to filter out properties based on the key.
     ...
     * <pre>
     * PropertiesComponent pc = getPropertiesComponent();
     * Map props = pc.loadPropertiesAsMap(key -> key.startsWith("zwangine.component.seda"));
     * </pre>
     *
     * @param  filter the predicate used to filter out properties based on the key.
     * @return        a {@link Map} representing the properties loaded.
     ...
     * override any default locations and only use the locations from this option. Zwangine loads by default from
     ...
     * multiple locations. Zwangine loads by default from classpath, so use file: as prefix to load from file system.
     */
