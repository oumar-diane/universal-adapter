...
/**
 * Meta data for EIPs, components, data formats and other Zwangine concepts
 *
 * For example to associate labels to Zwangine components
 */
...
public @interface Metadata {
    ...
    /**
     * The first version this functionality was added to  Zwangine.
     */
     ...
     *
     * This is for example used when a Zwangine component extend another component, and then may need to not use some of
    ...
    /**
     * Annotations data for Zwangine concepts such as components, EIP, etc.
     */
