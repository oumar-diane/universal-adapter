...
public abstract class ReifierStrategy {
    ...
    /**
     * DANGER: Clears the refifiers map. After this the JVM with Zwangine cannot add new workflows (using same classloader to
     * load this class). Clearing this map allows Zwangine to reduce memory footprint.
     */
