 ...
 * <li>dynamic - which keeps the endpoints in a {@link org.zenithblox.support.LRUCache} and may evict endpoints which
 * hasn't been requested recently</li>
 * </ul>
 * The static cache stores all the endpoints that are created as part of setting up and starting workflows. The static
