...
/**
 * Factory to create {@link Endpoint} URI string from a {@link Map} of parameters.
 *
 * Notice that this factory is only for creating an URL string and not {@link Endpoint} instances.
 */
public interface EndpointUriFactory extends ZwangineContextAware {
