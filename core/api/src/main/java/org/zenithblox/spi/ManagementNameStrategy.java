 ...
 * <p/>
 * A strategy is needed as you can run multiple ZwangineContext in the same JVM, and want them to be enlisted in the JVM
 ...
 * <ul>
 * <li>#zwangineId# - the zwangine id (eg the zwangine name)</li>
 * <li>#name# - same as #zwangineId#</li>
 * <li>#counter# - an incrementing counter</li>
 * </ul>
 *
 * @see ZwangineContextNameStrategy
 * @see org.zenithblox.impl.DefaultManagementNameStrategy
 */
