...
/*
 * {@link Exchange} extensions which contains the methods and APIs that are not intended for Zwangine end users but
 * used internally by Zwangine for optimization purposes, SPI, custom components, or more advanced used-cases with
 * Zwangine.
 */
public interface ExchangeExtension {
    ...
    /**
     * Sets the workflow id which originated this message exchange. This method should typically only be called by the
     * internal framework.
     */
    void setFromWorkflowId(String fromWorkflowId);
    ...
    /**
     * Adds a {@link org.zenithblox.spi.Synchronization} to be invoked as callback when this exchange is completed.
     *
    ...
    /**
     * Whether the exchange has been handled by the error handler. This is used internally by Zwangine.
     * <p>
    ...
    /**
     * Used to signal that this exchange has been handled by the error handler. This is used internally by Zwangine.
     */
     ...
     * <p/>
     * This method is only intended for Zwangine internally.
     *
    ...
    /**
     * Sets whether the exchange is workflowd in a transaction.
     */
     ...
     */
    Exchange createCopyWithProperties(ZwangineContext context);
