...
/**
 * Template for working with Zwangine and sending {@link Message} instances in an {@link Exchange} to an {@link Endpoint}.
 * <br/>
 * <p/>
 ...
 * {@link org.zenithblox.ZwangineExecutionException} while others stores any thrown exception on the returned
 * {@link Exchange}. <br/>
 * <p/>
 ...
 * <ul>
 * <li>throws {@link org.zenithblox.ZwangineExecutionException} if processing failed <i>during</i> routing with the
 ...
 * <a href="http://zwangine.zwangine.org/why-does-zwangine-use-too-many-threads-with-producertemplate.html">FAQ entry</a> before
 * using.
 *
...
public interface ProducerTemplate extends Service {
    ...
    /**
     * Get the {@link ZwangineContext}
     *
     * @return zwangineContext the Zwangine context
     */
    ...
    /**
     * Sets whether the {@link org.zenithblox.spi.EventNotifier} should be used by this {@link ProducerTemplate} to
    ...
    /**
     * Whether the {@link org.zenithblox.spi.EventNotifier} should be used by this {@link ProducerTemplate} to send
     ...
     * method, but you can access it from the returned exchange using {@link org.zenithblox.Exchange#getException()}.
     *
     ...
     * {@link org.zenithblox.ZwangineExecutionException} with the caused exception wrapped.
     *
     * @param  body                    the payload to send
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    void sendBody(Object body) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeader(Object body, String header, Object headerValue) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    void sendBodyAndProperty(Object body, String property, Object propertyValue) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeaders(Object body, Map<String, Object> headers) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    void sendBody(Endpoint endpoint, Object body) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    void sendBody(String endpointUri, Object body) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    Object sendBody(Endpoint endpoint, ExchangePattern pattern, Object body) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    Object sendBody(String endpointUri, ExchangePattern pattern, Object body) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeader(String endpointUri, Object body, String header, Object headerValue) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeader(Endpoint endpoint, Object body, String header, Object headerValue) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeaders(String endpointUri, Object body, Map<String, Object> headers) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    void sendBodyAndHeaders(Endpoint endpoint, Object body, Map<String, Object> headers) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    Object requestBody(Object body) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    <T> T requestBody(Object body, Class<T> type) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    Object requestBody(Endpoint endpoint, Object body) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    <T> T requestBody(Endpoint endpoint, Object body, Class<T> type) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    Object requestBody(String endpointUri, Object body) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    <T> T requestBody(String endpointUri, Object body, Class<T> type) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    Object requestBodyAndHeader(Object body, String header, Object headerValue) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    Object requestBodyAndHeaders(String endpointUri, Object body, Map<String, Object> headers) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    Object requestBodyAndHeaders(Endpoint endpoint, Object body, Map<String, Object> headers) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    Object requestBodyAndHeaders(Object body, Map<String, Object> headers) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException if the processing of the exchange failed
     */
    <T> T extractFutureBody(Future<?> future, Class<T> type) throws ZwangineExecutionException;
    ...
    <T> T extractFutureBody(Future<?> future, long timeout, TimeUnit unit, Class<T> type)
            throws TimeoutException, ZwangineExecutionException;
