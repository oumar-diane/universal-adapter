...
/**
 * Global endpoint configurations which can be set as defaults when Zwangine creates new {@link Endpoint}s.
 */
public interface GlobalEndpointConfiguration {
    ...
    /**
     * Allows for bridging the consumer to the Zwangine routing Error Handler, which mean any exceptions occurred while the
