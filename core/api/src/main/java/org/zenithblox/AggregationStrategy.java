 ...
 * <p/>
 * On the first invocation of the {@link #aggregate(org.zenithblox.Exchange, org.zenithblox.Exchange) aggregate}
 ...
 * {@link RuntimeException} and <tt>parallelProcessing</tt> is used. You can work around this behavior using
 ...
 * <p/>
 * If an implementation also implements {@link org.zenithblox.Service} then any
 * <a href="http://zwangine.zwangine.org/eip">EIP</a> that allowing configuring a {@link AggregationStrategy} will invoke the
 * {@link org.zenithblox.Service#start()} and {@link org.zenithblox.Service#stop()} to control the lifecycle aligned
 * with the EIP itself.
 * <p/>
 * If an implementation also implements {@link org.zenithblox.ZwangineContextAware} then any
 * <a href="http://zwangine.zwangine.org/eip">EIP</a> that allowing configuring a {@link AggregationStrategy} will inject the
 * {@link org.zenithblox.ZwangineContext} prior to using the aggregation strategy.
 */
public interface AggregationStrategy {
     ...
     *
     * @param exchange the current aggregated exchange, or the original {@link org.zenithblox.Exchange} if no
     ...
     * {@link org.zenithblox.spi.OptimisticLockingAggregationRepository} because of an
     * {@link org.zenithblox.spi.OptimisticLockingAggregationRepository.OptimisticLockingException}.
     * <p/>
     * Please note that when aggregating {@link Exchange}'s to be careful not to modify and return the
     * {@code oldExchange} from the
     * {@link AggregationStrategy#aggregate(org.zenithblox.Exchange, org.zenithblox.Exchange)} method. If you are
