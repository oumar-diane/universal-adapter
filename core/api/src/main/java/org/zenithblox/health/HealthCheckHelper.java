 ...
 *
 * The helper will look up the {@link HealthCheckRegistry} from {@link ZwangineContext} and gather all the registered
...
public final class HealthCheckHelper {
     ...
     */
    public static Collection<HealthCheck.Result> invoke(ZwangineContext zwangineContext) {
        return invoke(zwangineContext, check -> Map.of(HealthCheck.CHECK_KIND, HealthCheck.Kind.ALL), check -> false, null);
    }
     ...
     */
    public static Collection<HealthCheck.Result> invoke(ZwangineContext zwangineContext, String exposureLevel) {
        return invoke(zwangineContext, check -> Map.of(HealthCheck.CHECK_KIND, HealthCheck.Kind.ALL), check -> false,
                exposureLevel);
    }
     ...
     */
    public static Collection<HealthCheck.Result> invokeReadiness(ZwangineContext zwangineContext) {
        return invoke(zwangineContext, check -> Map.of(HealthCheck.CHECK_KIND, HealthCheck.Kind.READINESS),
     ...
     * @param exposureLevel level of exposure (full, oneline or default)
     */
    public static Collection<HealthCheck.Result> invokeReadiness(ZwangineContext zwangineContext, String exposureLevel) {
        return invoke(zwangineContext, check -> Map.of(HealthCheck.CHECK_KIND, HealthCheck.Kind.READINESS),
     ...
     */
    public static Collection<HealthCheck.Result> invokeLiveness(ZwangineContext zwangineContext) {
        return invoke(zwangineContext, check -> Map.of(HealthCheck.CHECK_KIND, HealthCheck.Kind.LIVENESS),
     ...
     * @param exposureLevel level of exposure (full, oneline or default)
     */
    public static Collection<HealthCheck.Result> invokeLiveness(ZwangineContext zwangineContext, String exposureLevel) {
        return invoke(zwangineContext, check -> Map.of(HealthCheck.CHECK_KIND, HealthCheck.Kind.LIVENESS),
    ...
    public static Collection<HealthCheck.Result> invoke(
        ...
        return invoke(zwangineContext, optionsSupplier, check -> false, null);
    }
    ...
    public static Collection<HealthCheck.Result> invoke(
        ...
        return invoke(zwangineContext, check -> Collections.emptyMap(), filter, null);
    }
    ...
    public static Collection<HealthCheck.Result> invoke(
        ...
        final HealthCheckRegistry registry = HealthCheckRegistry.get(zwangineContext);
     ...
     */
    public static Optional<HealthCheck.Result> invoke(ZwangineContext zwangineContext, String id, Map<String, Object> options) {
        final HealthCheckRegistry registry = HealthCheckRegistry.get(zwangineContext);
     ...
     */
    public static HealthCheckRegistry getHealthCheckRegistry(ZwangineContext context) {
        return context.getZwangineContextExtension().getContextPlugin(HealthCheckRegistry.class);
    }
     ...
     */
    public static HealthCheck getHealthCheck(ZwangineContext context, String id) {
        HealthCheck answer = null;

        HealthCheckRegistry hcr = context.getZwangineContextExtension().getContextPlugin(HealthCheckRegistry.class);
        if (hcr != null && hcr.isEnabled()) {
            ...
            if (check.isEmpty()) {
                ...
                HealthCheckResolver resolver
                        = context.getZwangineContextExtension().getContextPlugin(HealthCheckResolver.class);
     ...
     * @return         the health check, or <tt>null</tt> if no health check exists with this id
     */
    public static <T extends HealthCheck> T getHealthCheck(ZwangineContext context, String id, Class<T> type) {
     ...
     */
    public static HealthCheckRepository getHealthCheckRepository(ZwangineContext context, String id) {
     ...
     * @return         the health check repository, or <tt>null</tt> if no health check repository exists with this id
     */
    public static <T extends HealthCheckRepository> T getHealthCheckRepository(ZwangineContext context, String id, Class<T> type) {
    ...
    /**
     * Is the given key a reserved key used by Zwangine to store metadata in health check response details.
     *
     * @param  key the key
