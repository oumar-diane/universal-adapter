...
public interface Service extends AutoCloseable {
     ...
     * allows special optimizations such as zwangine-quarkus.
     *
     * @throws RuntimeZwangineException is thrown if build failed
     */
    default void build() {
    }
     ...
     *
     * @throws RuntimeZwangineException is thrown if initialization failed
     */
    default void init() {
    }
