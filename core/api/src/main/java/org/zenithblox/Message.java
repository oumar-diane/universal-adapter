...
/**
 * Implements the <a href="http://zwangine.zwangine.org/message.html">Message</a> pattern and represents an inbound or
 * outbound message as part of an {@link Exchange}.
 * <p/>
 * Headers are represented in Zwangine using a {@link org.zenithblox.util.CaseInsensitiveMap CaseInsensitiveMap}. The
 * implementation of the map can be configured by the {@link HeadersMapFactory} which can be set on the
 * {@link ZwangineContext}. The default implementation uses the {@link org.zenithblox.util.CaseInsensitiveMap
 * CaseInsensitiveMap}.
 */
public interface Message {
     ...
     * <p/>
     * A few Zwangine components do provide their own message IDs such as the JMS components.
     *
     ...
     * <p/>
     * Some systems like JMS, Kafka, AWS have a timestamp on the event/message, that Zwangine received. This method returns
     ...
     * the local timestamp when Zwangine created the exchange. The message timestamp is only available in some Zwangine
     ...
     * the {@link Map#entrySet()} method, which ensure you get the keys in the original case.
     *
     ...
     * <a href="http://zwangine.zwangine.org/stream-caching.html">stream caching</a>.
     *
     ...
     * <a href="http://zwangine.zwangine.org/stream-caching.html">stream caching</a>.
     * <p/>
     * The helper method {@link org.zenithblox.support.ExchangeHelper#getBodyAndResetStreamCache(Exchange, Class)} can
     ...
     *                                 exist
     * @throws TypeConversionException is thrown if error during type conversion
     * @see                            org.zenithblox.support.ExchangeHelper#getBodyAndResetStreamCache(Exchange,
     *                                 Class)
     */
