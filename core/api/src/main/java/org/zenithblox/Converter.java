 ...
 * which are then auto-discovered using the <a href="http://zwangine.zwangine.org/type-converter.html">Type Conversion
 * Support</a>
 */
...
public @interface Converter {
     ...
     *
     * <b>Important</b>: Fallback type converters is not recommended being used by Zwangine end users, but are used by
     * Zwangine internally and for some special Zwangine components.
     *
     ...
     * <p/>
     * This can be used if a Zwangine component provides multiple components where the end user can opt-out some of these
    ...
    /**
     * Whether to let the Zwangine compiler plugin to generate java source code for fast loading of the type converters.
     * <p/>
     * Important this configuration must be set on the class-level, not on the method.
     */
