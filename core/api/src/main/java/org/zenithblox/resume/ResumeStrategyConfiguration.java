...
public abstract class ResumeStrategyConfiguration {
    ...
    /**
     * Gets the {@link org.zenithblox.resume.Cacheable.FillPolicy} for the cache used in the strategy
     *
    ...
    /**
     * Sets the {@link org.zenithblox.resume.Cacheable.FillPolicy} for the cache used in the strategy
     *
     ...
     * {@link org.zenithblox.spi.annotations.JdkService} strategy .This allows the strategy to be resolved
