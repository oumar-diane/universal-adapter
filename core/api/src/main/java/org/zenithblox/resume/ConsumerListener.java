...
/**
 * An interface for listening to consumer events and allow proxying between a consumer predicate and the Zwangine
 * component. The whole of the consumer predicate is that of evaluating whether the consumption (from the internal Zwangine
