...
/**
 * A runtime exception if a given bean could not be found in the {@link org.zenithblox.spi.Registry}
 */
public class NoSuchBeanException extends RuntimeZwangineException {
