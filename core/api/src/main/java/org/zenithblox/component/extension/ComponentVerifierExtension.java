 ...
 */
package org.zenithblox.component.extension;

import org.zenithblox.Component;
import org.zenithblox.component.extension.ComponentVerifierExtensionHelper.*;
 ...
 * {@link #verify(Scope, Map)} which takes a scope and a set of parameters which should be
 * verified.
 * <p/>
...
public interface ComponentVerifierExtension extends ComponentExtension {
     ...
     * <ul>
     * <li><strong>{@link Scope#PARAMETERS}</strong>: to validate that all the mandatory
     * options are provided and syntactically correct.</li>
     * <li><strong>{@link Scope#CONNECTIVITY}</strong>: to validate that the given options
    ...
    interface VerificationError extends Serializable {
         ...
         * {@link org.zenithblox.component.extension.verifier.ResultErrorBuilder#detail(String, Object)}
         * <p>
