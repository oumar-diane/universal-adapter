 ...
 * {@link org.zenithblox.support.processor.validation.SchemaValidationException} so that it is easy to treat all
 * validation errors in a similar way irrespective of the particular validation technology used.
 */
public class ValidationException extends ZwangineExchangeException {
