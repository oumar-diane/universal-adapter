...
/**
 * A {@link org.zenithblox.spi.UnitOfWork} failed with a number of caused exceptions.
 * <p/>
 ...
 */
public class ZwangineUnitOfWorkException extends ZwangineExchangeException {

    private final transient List<Exception> causes;

    public ZwangineUnitOfWorkException(Exchange exchange, List<Exception> causes) {
