...
/**
 * Template for working with Zwangine and consuming {@link Message} instances in an {@link Exchange} from an
 * {@link Endpoint}. <br/>
 * <p/>
 * This template is an implementation of the <a href="http://zwangine.zwangine.org/polling-consumer.html">Polling Consumer
 * EIP</a>. This is <b>not</b> the <a href="http://zwangine.zwangine.org/event-driven-consumer.html">Event Driven Consumer
 * EIP</a>. <br/>
 * <p/>
 * The {@link ConsumerTemplate} is <b>thread safe</b>. <br/>
 * <p/>
 * <b>All</b> methods throws {@link RuntimeZwangineException} if consuming of the {@link Exchange} failed and an Exception
 * occurred. The <tt>getCause</tt> method on {@link RuntimeZwangineException} returns the wrapper original caused
 * exception.
 * <p/>
...
public interface ConsumerTemplate extends Service {
     ...
     * <p/>
     * This is needed to ensure any {@link org.zenithblox.spi.Synchronization} works is being executed. For example if
     ...
     * has been executed automatic by Zwangine itself.
     *
