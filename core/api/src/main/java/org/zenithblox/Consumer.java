...
public interface Consumer extends Service, EndpointAware {
     ...
     * can use autoRelease <tt>true</tt> and then Zwangine will automatic release the exchange after routing.
     *
     ...
     *
     * This implementation will use {@link org.zenithblox.spi.ExceptionHandler} to handle any exception on the
