 ...
 */
package org.zenithblox.support.service;
...
public final class ServiceHelper {
     ...
     * <p/>
     * If {@code service} is both {@link org.zenithblox.Suspendable} and {@link SuspendableService}
     * then its {@link SuspendableService#resume()} is called but <b>only</b> if {@code service} is
     * already {@link #isSuspended(Object) suspended}.
     * <p/>
     * If {@code service} is <b>not</b> a {@link org.zenithblox.Suspendable} and
     * {@link SuspendableService} then its {@link org.zenithblox.Service#start()} is called.
     * <p/>
     ...
     * <p/>
     * If {@code service} is both {@link org.zenithblox.Suspendable} and {@link SuspendableService}
     * then its {@link SuspendableService#suspend()} is called but <b>only</b> if {@code service} is
     * <b>not</b> already {@link #isSuspended(Object) suspended}.
     * <p/>
     * If {@code service} is <b>not</b> a {@link org.zenithblox.Suspendable} and
     * {@link SuspendableService} then its {@link org.zenithblox.Service#stop()} is called.
     * <p/>
     * Calling this method has no effect if {@code service} is {@code null}.
     *
     * @param  service   the service
