...
public class SSLContextParameters extends BaseSSLContextParameters {
     ...
     */
    public SSLContext createSSLContext(ZwangineContext zwangineContext) throws GeneralSecurityException, IOException {
        if (zwangineContext != null) {
            // setup ZwangineContext before creating SSLContext
            setZwangineContext(zwangineContext);
            if (keyManagers != null) {
                keyManagers.setZwangineContext(zwangineContext);
                if (keyManagers.getKeyStore() != null) {
                    keyManagers.getKeyStore().setZwangineContext(zwangineContext);
                }
            }
            if (trustManagers != null) {
                trustManagers.setZwangineContext(zwangineContext);
                if (trustManagers.getKeyStore() != null) {
                    trustManagers.getKeyStore().setZwangineContext(zwangineContext);
                }
            }
            if (secureRandom != null) {
                secureRandom.setZwangineContext(zwangineContext);
            }
            if (clientParameters != null) {
                clientParameters.setZwangineContext(zwangineContext);
            }
            if (serverParameters != null) {
                serverParameters.setZwangineContext(zwangineContext);
            }
        }
