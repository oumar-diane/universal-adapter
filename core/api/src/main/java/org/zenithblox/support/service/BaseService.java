 ...
 * <p/>
 * Implementations can extend this base class and implement {@link org.zenithblox.SuspendableService} in case they
...
public abstract class BaseService {
     ...
     * projects such as zwangine-quarkus.
     */
     ...
     * Implementations override this method to support customized start/stop.
     * <p/>
     * <b>Important:</b> Zwangine will invoke this {@link #doStop()} method when the service is being stopped. This method
     ...
     * when {@link org.zenithblox.ZwangineContext} is shutting down.
     *
     * @see #doStart()
     */
    ...
    /*
     * We log like this instead of using a statically declared logger in order to
