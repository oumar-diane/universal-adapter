 ...
 *
 * @see org.zenithblox.support.ExchangeHelper#getMandatoryProperty(Exchange, String, Class)
 */
public class NoSuchPropertyException extends ZwangineExchangeException {
