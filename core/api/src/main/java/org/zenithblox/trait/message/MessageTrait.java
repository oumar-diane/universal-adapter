...
package org.zenithblox.trait.message;

/**
 * Message traits are runtime traits that can be associated with a message (for instance, the redelivery state, a data
 * type, etc). This is specifically for internal usage of Zwangine and not a public API.
 */
public enum MessageTrait {
     ...
     * {@link org.zenithblox.spi.DataTypeAware}.
     */
    DATA_AWARE
}
