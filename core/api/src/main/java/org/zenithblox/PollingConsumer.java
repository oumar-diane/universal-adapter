...
/**
 * Represents a <a href="http://zwangine.zwangine.org/polling-consumer.html">Polling Consumer</a> where the caller polls for
 * messages when it is ready.
 * <p/>
 * When you are done with the returned {@link Exchange} you must ensure to invoke
 * {@link org.zenithblox.spi.UnitOfWork#done(Exchange)} to signal to Zwangine that the {@link Exchange} is done.
 * <p/>
 * This is needed to ensure any {@link org.zenithblox.spi.Synchronization} works is being executed. For example if you
 ...
 * {@link org.zenithblox.support.service.ServiceSupport#doInit()} or
 * {@link org.zenithblox.support.service.ServiceSupport#doStart()}.
 */
public interface PollingConsumer extends Consumer {
     ...
     * <p/>
     * <b>Important: </b> See the class javadoc about the need for done the {@link org.zenithblox.spi.UnitOfWork} on
