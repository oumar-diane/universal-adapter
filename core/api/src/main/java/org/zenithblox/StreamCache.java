 ...
 * {@link org.zenithblox.spi.StreamCachingStrategy} for determining if/how to wrap a stream-based message.
 * <p/>
 * The Zwangine routing engine uses the {@link org.zenithblox.processor.ZwangineInternalProcessor.StreamCachingAdvice} to
...
public interface StreamCache {
     ...
     * @throws IOException is thrown if the copy fails
     */
