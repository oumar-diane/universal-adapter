...
public interface FluentProducerTemplate extends Service {
    ...
    default FluentProducerTemplate to(String endpointUri) {
        final ZwangineContext context = ObjectHelper.notNull(getZwangineContext(), "zwangine context");
     ...
     *
     * @return                         the result
     * @throws ZwangineExecutionException is thrown if error occurred
     */
    Object request() throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException is thrown if error occurred
     */
    <T> T request(Class<T> type) throws ZwangineExecutionException;
     ...
     * @throws ZwangineExecutionException is thrown if error occurred
     */
    Exchange send() throws ZwangineExecutionException;
