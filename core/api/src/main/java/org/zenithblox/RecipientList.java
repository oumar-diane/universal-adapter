...
/**
 * Indicates that this method is to be used as a <a href="http://zwangine.zwangine.org/recipient-list.html">Dynamic Recipient
 * List</a> routing the incoming message to one or more endpoints.
 *
 * When a message {@link org.zenithblox.Exchange} is received from an {@link org.zenithblox.Endpoint} then the
 * <a href="http://zwangine.zwangine.org/bean-integration.html">Bean Integration</a> mechanism is used to map the incoming
 * {@link org.zenithblox.Message} to the method parameters.
 *
...
public @interface RecipientList {
     ...
     * This is the same behavior as in workflow, which is used by the routing engine.
     * <p/>
