...
import {CatalogService, UaSchemaDefinition} from "@/core";
import {isDefined} from "@/lib/utility";

export class ExpressionService {
    static getExpressionsSchema(schema: UaSchemaDefinition['schema']): UaSchemaDefinition['schema'] {
        /**
     ...
     * Ua expression has following 4 dialects, where the 2nd and 4th doesn't allow to configure
    ...
    private static getLanguageNames(): string[] {
        const languageCatalogMap = CatalogService.getLanguageMap();
