...
import { CanvasDefaults } from './canvas-default';
import {CanvasEdge, CanvasNode } from './canvas-model';
import { FlowService } from './flow-service';
import { CatalogModalContext, VisibleFlowsContext } from '@/providers';
import {CanvasSideBar, VisualizationEmptyState} from "@/components/visualization";
...
export const Canvas: FunctionComponent<PropsWithChildren<CanvasProps>> = ({ entities }) => {
    ...
    /** Context to interact with the CanvasPage catalog */
