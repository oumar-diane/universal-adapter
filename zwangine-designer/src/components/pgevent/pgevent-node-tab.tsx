...
export function PgeventNodeTab({props}:{[index:string]:any}) {
    return (
                    ...
                    <ScrollArea className="h-[370px]">
                        <CardContent className="space-y-2">
                            <div className="flex flex-col gap-2 text-primary">
                                {Object.values(props.data.component["properties"])?.map((property:{[index:string]:any}) => ComponentField(property))}
                            </div>
                        </CardContent>
                    </ScrollArea>
                </Card>
