...
import { IPropertiesTab } from './properties-modal-model.ts';
import './properties-modal.scss';
import { PropertiesTabs } from './properties-tabs';
import { EmptyTableState } from './table';
import {CatalogKind} from "@/core";
import {transformComponentIntoTab, transformProcessorComponentIntoTab} from "@/lib/ua-utils";
...
export const PropertiesModal: FunctionComponent<IPropertiesModalProps> = (props) => {
    ...
    const tabs = useMemo(() => {
        switch (props.tile.type) {
            case CatalogKind.Component:
                return transformComponentIntoTab(catalogService.getComponent(CatalogKind.Component, props.tile.name));

            case CatalogKind.Processor:
                return transformProcessorComponentIntoTab(
    ...
    const iconName = props.tile.name;
