import {
    AddStepMode, BaseVisualEntity,
    DISABLED_NODE_INTERACTION,
    IVisualizationNode,
    IVisualizationNodeData,
    NodeInteraction, VisualComponentSchema
 ...
 * this class act as a wrapper of the {@link BaseVisualEntity}.
 */
class VisualizationNode<T extends IVisualizationNodeData = IVisualizationNodeData> implements IVisualizationNode<T> {
    ...
    getNodeLabel(nodeLabelType?:NodeLabelType): string {
        return this.getBaseEntity()?.getNodeLabel(this.data.path, nodeLabelType) ?? this.id;
    }
