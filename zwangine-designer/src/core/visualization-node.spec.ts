...
describe('getNodeTitle', () => {
    it('should delegate to the base entity to get the title', () => {
        const visualEntity = new WorkflowVisualEntity(workflowAbstractRepresentation);
        const getNodeTitleSpy = vi.spyOn(visualEntity, 'getNodeTitle');

        node = createVisualizationNode('test', { path: 'workflow.from.steps.2.to', entity: visualEntity });

        expect(node.getNodeTitle()).toEqual('direct');
        expect(getNodeTitleSpy).toHaveBeenCalledWith('workflow.from.steps.2.to');
    });
...
it('should return the base entity ID if no path provided', () => {
    const visualEntity = new WorkflowVisualEntity(workflowAbstractRepresentation);
    node = createVisualizationNode('test', { entity: visualEntity });

    expect(node.getId()).toEqual('workflow-8888');
});

it('should return the component schema from the underlying BaseVisualEntity', () => {
    const getComponentSchemaSpy = vi.fn();
    const visualEntity = {
...
it('should delegate getOmitFormFields() to the underlying BaseVisualEntity', () => {
...
describe('getNodeLabel', () => {
    it('should return the label from the underlying BaseVisualEntity', () => {
    ...
    it('should return the id when the underlying BaseVisualEntity is not defined', () => {
        node = createVisualizationNode('test', {});
...
describe('getTooltipContent', () => {
    it('should return the tootltip content from the underlying BaseVisualEntity', () => {
        const getTooltipContentSpy = vi.fn().mockReturnValue('test-description');
        const visualEntity = {
...
describe('updateModel', () => {
    it('should update the model on the underlying BaseVisualEntity', () => {
...
describe('removeChild', () => {
    ...
    it('should delegate to the BaseVisualEntity to remove the underlying child', () => {
        const camelWorkflowVisualEntityStub = new WorkflowVisualEntity(workflowAbstractRepresentation);

        node = camelWorkflowVisualEntityStub.toVizNode();
...
describe('getNodeValidationText', () => {
    it('should return undefined when the underlying BaseVisualEntity is not defined', () => {
        node = createVisualizationNode('test', {});
    ...
    it('should return the validation text from the underlying BaseVisualEntity', () => {
