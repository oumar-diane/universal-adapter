...
import { NodeIconResolver, NodeIconType, isDefined, setValue } from '@/lib/utility';
import { getRandomId } from '@/lib/ua-utils';
import {ProcessorDefinition, RestConfiguration} from '@/@types';
...
export class RestConfigurationVisualEntity implements BaseVisualEntity {
    id: string;
    ...
    constructor(public restConfigurationDef: { restConfiguration: RestConfiguration } = { restConfiguration: {} }) {
        const id = getRandomId('restConfiguration');
        this.id = id;
    }
    ...
    getRootPath(): string {
        return RestConfigurationVisualEntity.ROOT_PATH;
    }
    ...
    getComponentSchema(): VisualComponentSchema {
        const schema = CatalogService.getComponent(CatalogKind.Entity, 'restConfiguration');
