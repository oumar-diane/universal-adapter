...
import { Component, ComponentHeader, ComponentProperty, SupportedComponent } from '../model/component-models';
...
export class ComponentApi {
    ...
    static findStepComponent = (step?: WorkflowElement): Component | undefined => {
        return ComponentApi.findByName((step as any)?.uri)
    };

    static getComponentHeadersList = (step?: WorkflowElement): ComponentHeader [] => {
    ...
    static parseSyntax = (syntax: string): string[] => {
        ...
        separators.forEach(s => {
            simplifiedSyntax = simplifiedSyntax?.replace(s, ':');
        });
    ...
    static parseUri = (uri?: string): string[] => {
        ...
        separators.forEach(s => {
            simplifiedUri = simplifiedUri.replace(s, ':');
        });
    ...
    static getComponentHeaders = (componentName: string): ComponentHeader[] => {
        const component: Component | undefined = ComponentApi.findByName(componentName);
