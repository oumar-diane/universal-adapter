...
import {CatalogTilesContext, CatalogContext} from "@/providers"
import './catalog-modal-provider.scss';
import {CatalogKind, DefinedComponent} from '@/core';
 ...
 * It is used in the CanvasPage component to open the catalog modal when the user clicks on the catalog button.
 *
