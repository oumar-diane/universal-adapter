...
public abstract class GenericFileComponent<T> extends HealthCheckComponent {
    ...
    protected GenericFileComponent(ZwangineContext context) {
        super(context);
    }
    ...
    private Comparator<Exchange> createSortByComparator(Iterator<String> it) {
        ...
        return GenericFileDefaultSorter.sortByFileLanguage(getZwangineContext(), reminder, reverse, ignoreCase,
