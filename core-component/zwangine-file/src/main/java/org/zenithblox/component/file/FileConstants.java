...
public final class FileConstants {
    ...
    @Metadata(description = "(producer) Specifies the name of the file to write (relative to the endpoint"
                            ...
                            + " `null` then Zwangine will auto-generate a filename based on the message"
    ...
    @Metadata(label = "consumer", description = "A `boolean` option specifying whether the consumed file denotes an"
                                                ...
                                                + " elsewhere as well.",
              javaType = "Boolean")
    public static final String FILE_ABSOLUTE = "ZwangineFileAbsolute";
    @Metadata(label = "consumer", description = "The absolute path to the file. For relative files this path holds the"
                                                + " relative path instead.",
              javaType = "String")
    public static final String FILE_ABSOLUTE_PATH = "ZwangineFileAbsolutePath";
    @Metadata(label = "consumer", description = "The extended attributes of the file", javaType = "Map<String, Object>")
    public static final String FILE_EXTENDED_ATTRIBUTES = "ZwangineFileExtendedAttributes";
    ...
    public static final String FILE_RELATIVE_PATH = "ZwangineFileRelativePath";
    ...
    @Metadata(label = "producer", description = "The actual absolute filepath (path + name) for the output file that was"
                                                + " written. This header is set by Zwangine and its purpose is providing"
    ...
    @Metadata(label = "producer", description = "Is used for overruling `ZwangineFileName` header and use the"
    ...
    public static final String INITIAL_OFFSET = "ZwangineFileInitialOffset";

    /**
     * Sub folder used by zwangine-file as default sub-folder for moving processing file when they are done.
     */
    public static final String DEFAULT_SUB_FOLDER = ".zwangine";
