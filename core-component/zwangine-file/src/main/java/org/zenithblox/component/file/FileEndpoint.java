...
import org.zenithblox.component.file.strategy.FileProcessStrategyFactory;
...
public class FileEndpoint extends GenericFileEndpoint<File> {
    ...
    protected GenericFileProcessStrategy<File> createGenericFileStrategy() {
        return new FileProcessStrategyFactory().createGenericFileProcessStrategy(getZwangineContext(), getParamsAsMap());
    }
