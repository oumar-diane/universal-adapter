 ...
 * party.
 * <p/>
 * Zwangine supports out of the box the following strategies:
 * <ul>
 ...
 * <li>FileIdempotentRepositoryReadLockStrategy using a {@link org.zenithblox.spi.IdempotentRepository} to hold the
...
public interface GenericFileExclusiveReadLockStrategy<T> {
     ...
     * @return            <tt>true</tt> if read lock was acquired. If <tt>false</tt> Zwangine will skip the file and try it
     *                    on the next poll
     * @throws Exception  can be thrown in case of errors
     */
