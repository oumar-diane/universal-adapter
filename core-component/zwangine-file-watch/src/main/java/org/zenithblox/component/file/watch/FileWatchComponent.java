...
public class FileWatchComponent extends DefaultComponent {
    ...
    @Metadata(label = "advanced",
              description = "The number of concurrent consumers. Increase this value, if your workflow is slow to prevent buffering in queue.",
              defaultValue = "1")
    ...
    protected void doInit() throws Exception {
        super.doInit();
        Registry registry = getZwangineContext().getRegistry();
